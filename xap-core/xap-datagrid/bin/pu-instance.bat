...
set COMMAND_LINE=%JAVACMD% %JAVA_OPTIONS% %XAP_OPTIONS% -classpath %PRE_CLASSPATH%;%GS_JARS%;%SPRING_JARS%;%POST_CLASSPATH% org.openspaces.pu.container.standalone.StandaloneProcessingUnitContainer %*
