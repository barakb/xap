...
public class LoadBalancingPolicyTest extends TestCase {

    private LoadBalancingPolicy full;
    private LoadBalancingPolicy empty;
    private ExternalizableTestHelper helper;

    protected void setUp() throws Exception {
        helper = new ExternalizableTestHelper();
        full = helper.fill(new LoadBalancingPolicy());
        empty = new LoadBalancingPolicy();
    }
