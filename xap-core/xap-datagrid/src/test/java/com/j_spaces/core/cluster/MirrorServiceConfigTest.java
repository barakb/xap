...
public class MirrorServiceConfigTest extends TestCase {

    private MirrorServiceConfig full;
    private MirrorServiceConfig empty;
    private ExternalizableTestHelper helper;

    protected void setUp() throws Exception {
        helper = new ExternalizableTestHelper();
        full = helper.fill(new MirrorServiceConfig());
        empty = new MirrorServiceConfig();
    }
