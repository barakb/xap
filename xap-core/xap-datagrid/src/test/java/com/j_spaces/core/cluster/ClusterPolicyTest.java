...
public class ClusterPolicyTest extends TestCase {
    private ClusterPolicy clusterPolicy;
    private ClusterPolicy empty;
    private ExternalizableTestHelper helper;

    protected void setUp() throws Exception {
        helper = new ExternalizableTestHelper();
        clusterPolicy = helper.fill(new ClusterPolicy());
        clusterPolicy.m_ReplicationPolicy = new ReplicationPolicy("clusterName", "replicationGroupName",
                new ArrayList<String>(), new ArrayList<SpaceURL>(), "ownMemberName",
                new Hashtable<String, ReplicationPolicyDescription>(), new SyncReplPolicy("nodeNames"), new MultiBucketReplicationPolicy(), new SwapBacklogConfig());
        empty = new ClusterPolicy();
    }
