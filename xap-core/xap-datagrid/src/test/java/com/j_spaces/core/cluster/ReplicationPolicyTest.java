...
public class ReplicationPolicyTest extends TestCase {

    private ReplicationPolicy full;
    private ReplicationPolicy empty;
    private ExternalizableTestHelper helper;

    protected void setUp() throws Exception {
        helper = new ExternalizableTestHelper();
        full = helper.fill(new ReplicationPolicy());
        empty = new ReplicationPolicy();
    }
