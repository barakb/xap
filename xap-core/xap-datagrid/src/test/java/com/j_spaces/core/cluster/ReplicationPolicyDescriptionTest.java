...
public class ReplicationPolicyDescriptionTest extends TestCase {
    private ReplicationPolicyDescription replicationPolicyDesc;
    private ReplicationPolicyDescription empty;
    private ExternalizableTestHelper helper;

    protected void setUp() throws Exception {
        helper = new ExternalizableTestHelper();
        replicationPolicyDesc = helper.fill(new ReplicationPolicyDescription());
        replicationPolicyDesc.replTransmissionPolicies = null;
        empty = new ReplicationPolicyDescription();
    }
