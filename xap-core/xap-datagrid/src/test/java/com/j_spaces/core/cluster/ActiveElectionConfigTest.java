...
public class ActiveElectionConfigTest extends TestCase {

    private ActiveElectionConfig full;
    private ActiveElectionConfig empty;
    private ExternalizableTestHelper helper;

    protected void setUp() throws Exception {
        helper = new ExternalizableTestHelper();
        full = helper.fill(new ActiveElectionConfig());
        empty = new ActiveElectionConfig();
    }
