...
/**
 * Type to test affect of IncludeProperties.IMPLICIT on property inclusion.
 *
 * @author Niv Ingberg
 * @since 7.0.1
 */
@SpaceClass(includeProperties = IncludeProperties.IMPLICIT)
@com.gigaspaces.api.InternalApi
public class PojoImplicit {
