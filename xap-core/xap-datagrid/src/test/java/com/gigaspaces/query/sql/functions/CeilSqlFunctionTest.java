...
public class CeilSqlFunctionTest {

    private CeilSqlFunction ceilSqlFunction;

    @Before
    public void setUp() throws Exception {
        ceilSqlFunction = new CeilSqlFunction();
    }
    ...
    public void testApplyNegativeInteger() throws Exception {
        ...
        Object res = ceilSqlFunction.apply(sqlFunctionExecutionContext);
        assertNotNull(res);
    ...
    public void testApplyWrongType() throws Exception {
        ...
        ceilSqlFunction.apply(sqlFunctionExecutionContext);
    }
}