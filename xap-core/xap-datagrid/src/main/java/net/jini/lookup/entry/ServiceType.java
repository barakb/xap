...
public abstract class ServiceType extends AbstractEntry
    ...
    /**
     * Get an icon for this service.  This icon may be localized where appropriate.  The valid
     * parameter values are the same as for the getIcon method of java.beans.BeanInfo.
     *
