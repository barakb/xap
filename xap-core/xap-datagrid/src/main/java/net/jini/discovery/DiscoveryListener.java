...
public interface DiscoveryListener extends EventListener {
    /**
     * Called when one or more lookup service registrars has been discovered. The method should
     * return quickly; e.g., it should not make remote calls.
     *
    ...
    /**
     * Called when one or more lookup service registrars has been discarded. The method should
     * return quickly; e.g., it should not make remote calls.
     *
