...
public class CeilSqlFunction extends SqlFunction {
    ...
    public Object apply(SqlFunctionExecutionContext context) {
        ...
        if (!(arg instanceof Number)) {
            throw new RuntimeException("Ceil function - wrong argument type, should be a Number - : " + arg);
        }
        if (arg instanceof Double) {
            ...
            throw new RuntimeException("Ceil function - wrong argument type - unsupported Number type : " + arg);
        }
    }
}
