...
/**
 * Holds iterable results of the <code>readByIds</code> operation. When iterating through the
 ...
 * <code>readByIds</code> method.
 *
 * @author idan
 * @since 7.1.1
 */
public interface ReadByIdsResult<T> extends Iterable<T> {
    /**
    ...
    /**
     * Returns the results array for the <code>readByIds</code> operation. <p>The array's size is
