...
/**
 * Represents a change operation which correlate with a {@link ChangeSet#addToCollection(String,
...
public class AddToCollectionOperation {
     ...
     */
    public static final String NAME = "addToCollection";

    private AddToCollectionOperation() {
    }
    ...
    public static Serializable getItem(ChangeOperation changeOperation) {
        if (!(changeOperation instanceof AddToCollectionSpaceEntryMutator))
            throw new IllegalArgumentException("The argument is not of legit type - " + changeOperation);
        return ((AddToCollectionSpaceEntryMutator) changeOperation).getItem();
    }

    /**
     * @return the return value of the {@link Collection#add(Object)} operation that was applied.
     * @since 9.7
     */
    ...
    /**
     * @return the size of the collection after the {@link Collection#add(Object)} operation that
     * was applied.
     * @since 9.7
     */
