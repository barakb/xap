...
/**
 * Represents a change operation which correlate with a {@link ChangeSet#addAllToCollection(String,
...
public class AddAllToCollectionOperation {
     ...
     */
    public static final String NAME = "addAllToCollection";

    private AddAllToCollectionOperation() {
    }
    ...
    public static Collection<? extends Serializable> getItems(ChangeOperation changeOperation) {
        if (!(changeOperation instanceof AddAllToCollectionSpaceEntryMutator))
            throw new IllegalArgumentException("The argument is not of legit type - " + changeOperation);
        return ((AddAllToCollectionSpaceEntryMutator) changeOperation).getItems();
    }

    /**
     * @return the return value of the {@link Collection#addAll(Collection)} operation that was
     * applied.
     * @since 9.7
     */
    ...
    /**
     * @return the size of the collection after the {@link Collection#addAll(Collection)} operation
     * that was applied.
     * @since 9.7
     */
