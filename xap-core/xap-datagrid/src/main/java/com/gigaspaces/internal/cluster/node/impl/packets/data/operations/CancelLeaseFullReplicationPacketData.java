...
public class CancelLeaseFullReplicationPacketData
        extends SingleReplicationPacketData {
    private static final long serialVersionUID = 1L;

    public CancelLeaseFullReplicationPacketData() {
    }

    public CancelLeaseFullReplicationPacketData(IEntryPacket entry, boolean fromGateway) {
    ...
    public String toString() {
        return "ENTRY LEASE CANCELLED: " + getEntryPacket();
    }
    ...
    public void execute(IReplicationInContext context,
        ...
        inReplicationHandler.inCancelEntryLease(context, getEntryPacket());
    }
