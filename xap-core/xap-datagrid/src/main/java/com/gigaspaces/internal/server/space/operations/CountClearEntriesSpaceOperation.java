...
public class CountClearEntriesSpaceOperation extends AbstractSpaceOperation<CountClearEntriesSpaceOperationResult, CountClearEntriesSpaceOperationRequest> {
    @Override
    ...
    @Override
    public String getLogName(CountClearEntriesSpaceOperationRequest request,
                             CountClearEntriesSpaceOperationResult result) {
        return request.isClear() ? "clear" : "count";
    }
