...
public class EntryCopyReplicaData extends AbstractEntryReplicaData

{
    private static final long serialVersionUID = 1L;

    public EntryCopyReplicaData() {
    }

    public EntryCopyReplicaData(IEntryPacket entryPacket) {
        super(entryPacket);
    }

    @Override
    public ReplicaType getReplicaType() {
        return ReplicaType.COPY;
    }
