...
public class GetTypeDescriptorTask extends SystemDistributedTask<GetTypeDescriptorActionInfo> {
    private static final long serialVersionUID = 1L;

    private GetTypeDescriptorActionInfo _actionInfo;

    @Override
    public String toString() {
        return "GetTypeDescriptorTask [" + _actionInfo.typeName + "]";
    }
