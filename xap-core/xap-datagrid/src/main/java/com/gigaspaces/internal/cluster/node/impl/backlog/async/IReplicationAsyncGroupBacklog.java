...
package com.gigaspaces.internal.cluster.node.impl.backlog.async;
...
public interface IReplicationAsyncGroupBacklog extends IReplicationGroupBacklog {

    void add(IAsyncReplicationGroupOutContext groupContext,
             IEntryHolder entryHolder, ReplicationSingleOperationType operationType);

    void addGeneric(IAsyncReplicationGroupOutContext groupContext,
                    Object operationData, ReplicationSingleOperationType operationType);

    void addTransaction(IAsyncReplicationGroupOutContext groupContext,
