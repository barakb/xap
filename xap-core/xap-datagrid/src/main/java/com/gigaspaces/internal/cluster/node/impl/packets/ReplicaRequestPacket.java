...
public class ReplicaRequestPacket
    ...
    public Object accept(IIncomingReplicationFacade incomingReplicationFacade) {
        return incomingReplicationFacade.newReplicaRequest(getSourceLookupName(), this);
    }
    ...
    public void toText(Textualizer textualizer) {
        ...
        textualizer.appendNewLine("parameters", _parameters);
    }
