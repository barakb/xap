...
public class AllInCacheCentralDBBackupSpaceRecovery extends BackupSpaceRecovery {
    /**
     * @param space
     */
    public AllInCacheCentralDBBackupSpaceRecovery(SpaceImpl space) {
        super(space);
    }

    @Override
    public ISpaceSynchronizeReplicaState recoverFromOtherSpace() throws Exception {
        return recoverAllFromPrimary();
