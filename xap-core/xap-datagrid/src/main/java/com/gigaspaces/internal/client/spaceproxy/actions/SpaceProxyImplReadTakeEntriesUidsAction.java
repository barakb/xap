...
public class SpaceProxyImplReadTakeEntriesUidsAction
        extends ReadTakeEntriesUidsProxyAction<SpaceProxyImpl> {

    @Override
    public ReadTakeEntriesUidsResult readTakeEntriesUids(SpaceProxyImpl spaceProxy,
                                                         ReadTakeEntriesUidsSpaceOperationRequest request) {
        spaceProxy.beforeSpaceAction(request.getTransaction());
        try {
