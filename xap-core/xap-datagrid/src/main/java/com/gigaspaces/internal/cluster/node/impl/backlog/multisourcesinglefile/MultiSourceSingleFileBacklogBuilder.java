...
public class MultiSourceSingleFileBacklogBuilder
        implements IReplicationBacklogBuilder {

    private final String _name;
    private final IReplicationPacketDataProducer<?> _dataProducer;

    public MultiSourceSingleFileBacklogBuilder(String name,
    ...
    public IReplicationAsyncGroupBacklog createAsyncGroupBacklog(
            DynamicSourceGroupConfigHolder groupConfig) {
        return new MultiSourceSingleFileAsyncGroupBacklog(groupConfig, _name, _dataProducer);
    }

    @Override
    public IReplicationReliableAsyncGroupBacklog createReliableAsyncGroupBacklog(
            DynamicSourceGroupConfigHolder groupConfig) {
        return new MultiSourceSingleFileReliableAsyncGroupBacklog(groupConfig, _name, _dataProducer);
    }

    @Override
    public String toString() {
        return "MultiSourceSingleFileBacklogBuilder [_dataProducer=" + _dataProducer
                + ", _name=" + _name + "]";
    }
