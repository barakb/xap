 ...
 * @since 8.0.5
 */
public abstract class WriteProxyAction<TSpaceProxy extends ISpaceProxy> {
    public abstract LeaseContext<?> write(TSpaceProxy spaceProxy, WriteProxyActionInfo actionInfo)
            throws RemoteException, TransactionException, InterruptedException;

    public abstract LeaseContext<?>[] writeMultiple(TSpaceProxy spaceProxy, WriteMultipleProxyActionInfo actionInfo)
            throws RemoteException, TransactionException, InterruptedException;
}
