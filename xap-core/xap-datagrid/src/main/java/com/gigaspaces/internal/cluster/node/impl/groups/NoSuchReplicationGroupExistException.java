...
/**
 * Thrown when trying to retrieve a replication group from a {@link IIncomingReplicationFacade} that
 * do not exists
 *
 * @author eitany
 * @since 8.0
...
public class NoSuchReplicationGroupExistException
        extends BrokenReplicationTopologyException {
