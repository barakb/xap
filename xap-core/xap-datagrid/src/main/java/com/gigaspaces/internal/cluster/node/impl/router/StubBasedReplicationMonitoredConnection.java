...
public class StubBasedReplicationMonitoredConnection
        extends
        AbstractProxyBasedReplicationMonitoredConnection<IReplicationConnectionProxy, Object> {

    public StubBasedReplicationMonitoredConnection(
            AbstractConnectionProxyBasedReplicationRouter router,
            String targetLookupName,
            IReplicationConnectionProxy connectionProxy,
            IConnectionMonitor monitor, ConnectionState state,
            Exception disconnectionReason, Uuid proxyId,
    ...
    protected void onClose() {
        getRouter().removeDirectConnection(this);
    }
