...
public class StandardGetterMethod<T> extends StandardMethod<T> implements
        IGetterMethod<T> {

    public StandardGetterMethod(Method method) {
        super(method);
    }

    public Object get(T obj) throws IllegalAccessException,
