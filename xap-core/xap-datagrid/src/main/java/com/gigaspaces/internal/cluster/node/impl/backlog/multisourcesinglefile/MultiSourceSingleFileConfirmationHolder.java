...
public class MultiSourceSingleFileConfirmationHolder
        extends GlobalOrderConfirmationHolder {
    ...
    public void setLastReceivedKey(long lastReceivedKey) {
        _lastReceivedKey = lastReceivedKey;
    }

    @Override
    public String toString() {
        return super.toString() + ", lastReceivedKey=" + _lastReceivedKey;
    }
