...
public interface IReplicationNodeStateListener extends IReplicationTargetGroupStateListener, IReplicationSourceGroupStateListener {
    /**
     * Called when new replica request is received, for custom validation
     *
     * @since 8.0.4
     */
    void onNewReplicaRequest(String groupName, String channelName, boolean isSynchronizeRequest);
     ...
     * @since 9.5.0
     */
    void onReplicationNodeModeChange(ReplicationNodeMode newMode);
}
