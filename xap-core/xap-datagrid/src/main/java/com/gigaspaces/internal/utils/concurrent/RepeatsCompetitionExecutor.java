...
public class RepeatsCompetitionExecutor<T extends CompetitiveTask> extends CompetitionExecutor<T> {
    ...
    protected CompetitorWrapper wrapCompetitor(T competitor) {
        return new RepeatsCompetitorWrapper(competitor);
    }

    private class RepeatsCompetitorWrapper extends CompetitorWrapper {
