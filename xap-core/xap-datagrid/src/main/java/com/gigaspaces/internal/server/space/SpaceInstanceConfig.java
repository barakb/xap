...
public class SpaceInstanceConfig {
    ...
    public SpaceTypeDescriptor[] getTypeDescriptors() {
    ...
    public QueryExtensionProvider[] getQueryExtensionProviders() {
        return queryExtensionProviders;
    }
