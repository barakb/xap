...
public class MultiSourceSingleFileBacklogConfig
        extends BacklogConfig {
    @Override
    public MultiSourceSingleFileBacklogConfig clone() {
        MultiSourceSingleFileBacklogConfig clone = new MultiSourceSingleFileBacklogConfig();
