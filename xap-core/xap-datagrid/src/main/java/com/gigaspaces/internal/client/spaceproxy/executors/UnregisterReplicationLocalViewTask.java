...
public class UnregisterReplicationLocalViewTask extends SystemTask<SpaceResponseInfo> {
    private static final long serialVersionUID = 1L;

    private UnregisterReplicationLocalViewRequestInfo _actionInfo;

    public UnregisterReplicationLocalViewTask() {
    }

    public UnregisterReplicationLocalViewTask(UnregisterReplicationLocalViewRequestInfo actionInfo) {
