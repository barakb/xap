...
/**
 * An extension of {@link IReplicationPacketData} that can be self executed.
 *
 * @author anna
 * @since 8.0
 */
public interface IExecutableReplicationPacketData<T extends IReplicationPacketEntryData>
        extends IReplicationPacketData<T> {
    ...
    public IExecutableReplicationPacketData<T> createEmptyMultipleEntryData();
