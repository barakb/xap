...
public class SpaceReplicationSettings
        extends ReplicationSettings implements ISpaceReplicationSettings {

    private final String spaceMemberName;
    private final List<String> groupMemberNames;

    public SpaceReplicationSettings(String spaceMemberName,
