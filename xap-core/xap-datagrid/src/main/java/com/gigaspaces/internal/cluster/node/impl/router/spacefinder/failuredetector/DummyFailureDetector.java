...
public class DummyFailureDetector
        implements IFailureDetector {

    public void registerRemoteSpace(FaultDetectionListener listener,
                                    ServiceID serviceId, IRemoteSpace spaceProxy) throws Exception {
        //Do nothing
    }
