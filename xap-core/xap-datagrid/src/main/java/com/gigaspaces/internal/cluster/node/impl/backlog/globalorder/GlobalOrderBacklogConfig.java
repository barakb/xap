...
public class GlobalOrderBacklogConfig extends BacklogConfig {
    @Override
    public GlobalOrderBacklogConfig clone() {
        GlobalOrderBacklogConfig clone = new GlobalOrderBacklogConfig();
