...
public class FetchEndpointDetailsPacket
        extends AbstractReplicationPacket<ReplicationEndpointDetails> {

    private static final long serialVersionUID = 1L;

    public FetchEndpointDetailsPacket() {
    }

    @Override
    protected void writeExternalImpl(ObjectOutput out, PlatformLogicalVersion endpointLogicalVersion)
            throws IOException {
    }
    ...
    @Override
    public ReplicationEndpointDetails accept(IIncomingReplicationFacade incomingReplicationFacade) {
        return incomingReplicationFacade.getEndpointDetails();
    }
