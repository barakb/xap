...
/**
 * Batch all the existing replication in handlers {@link IReplicationNode}
 *
 * @author eitany
 * @since 8.0
 */
public interface IReplicationInFacade
        extends IReplicationInEntryLeaseCancelledHandler,
...
{
    IReplicationSourceGroup getReplicationSourceGroup(String groupName);
