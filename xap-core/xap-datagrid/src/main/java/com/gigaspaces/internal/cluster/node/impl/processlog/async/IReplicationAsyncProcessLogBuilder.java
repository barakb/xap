...
package com.gigaspaces.internal.cluster.node.impl.processlog.async;
...
public interface IReplicationAsyncProcessLogBuilder {
    IReplicationAsyncTargetProcessLog createAsyncProcessLog(
    ...
    IReplicationBatchConsumeAsyncTargetProcessLog createBatchConsumeAsyncProcessLog(
            TargetGroupConfig groupConfig, IBacklogHandshakeRequest handshakeRequest,
            IReplicationInFacade replicationInFacade,
            IReplicationProcessLogExceptionHandler exceptionHandler,
            String myLookupName, String groupNameString, String sourceLookupName, IReplicationGroupHistory groupHistory);
}
