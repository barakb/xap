...
public class EntryLeaseExpiredReplicationPacketData
    ...
    public EntryLeaseExpiredReplicationPacketData(String className, String uid,
    ...
    protected void executeImpl(IReplicationInContext context,
        ...
        inReplicationHandler.inEntryLeaseExpiredByUID(context, getTypeName(), getUid(), isTransient(), getOperationId());
    }
    ...
    public String toString() {
        return "ENTRY LEASE EXPIRED: (class name=" + getTypeName() + " uid=" + getUid() + ")";
    }
