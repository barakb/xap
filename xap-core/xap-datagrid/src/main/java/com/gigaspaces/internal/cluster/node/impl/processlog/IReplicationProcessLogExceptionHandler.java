...
public interface IReplicationProcessLogExceptionHandler {

    IDataConsumeFix handleException(IDataConsumeResult errorResult, IReplicationOrderedPacket packet) throws Exception;
