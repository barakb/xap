...
public class AsyncSingleOriginReplicationTargetGroupBuilder
    ...
    public AsyncSingleOriginReplicationTargetGroupBuilder(
    ...
    public IReplicationTargetGroup createStaticGroup(
        ...
        return new AsyncSingleOriginReplicationTargetGroup(_groupConfig,
                replicationRouter,
                _processLogBuilder,
                replicationInFacade,
    ...
    public String toString() {
        return "AsyncSingleOriginReplicationTargetGroupBuilder [_groupConfig="
