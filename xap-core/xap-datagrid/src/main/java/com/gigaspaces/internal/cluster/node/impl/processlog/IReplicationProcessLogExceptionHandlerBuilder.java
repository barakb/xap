...
public interface IReplicationProcessLogExceptionHandlerBuilder {
    IReplicationProcessLogExceptionHandler createExceptionHandler(
            IReplicationConnection sourceConnection,
            String sourceMemberLookupName, String groupName);
}
