...
public class CountClearEntriesSpaceOperationResult extends SpaceOperationResult {
     ...
     */
    public CountClearEntriesSpaceOperationResult() {
    }

    public CountClearEntriesSpaceOperationResult(int count, Exception ex) {
        _count = count;
    ...
    public void toText(Textualizer textualizer) {
        ...
        textualizer.append("count", _count);
    }
