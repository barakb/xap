...
public class AbortPreparedTransactionSpaceOperationRequest extends SpaceOperationRequest<AbortPreparedTransactionSpaceOperationResult> {
     ...
     */
    public AbortPreparedTransactionSpaceOperationRequest() {
    }

    public AbortPreparedTransactionSpaceOperationRequest(TransactionManager mgr, long id, int partitionId, OperationID operationID) {
        _mgr = mgr;
        _id = id;
    ...
    public AbortPreparedTransactionSpaceOperationRequest(TransactionManager mgr, Object xid, int partitionId, OperationID operationID) {
        if (xid == null)
    ...
    @Override
    public AbortPreparedTransactionSpaceOperationResult createRemoteOperationResult() {
        return new AbortPreparedTransactionSpaceOperationResult();
    }
    ...
    public int getOperationCode() {
        return SpaceOperationsCodes.ABORT_TRANSACTION;
    }
