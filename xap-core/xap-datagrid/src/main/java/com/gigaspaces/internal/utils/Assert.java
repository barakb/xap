...
public abstract class Assert {
     ...
     * result is <code>false</code>. <pre class="code">Assert.isTrue(i &gt; 0, "The value must be
    ...
    /**
     * Assert that an object is <code>null</code> . <pre class="code">Assert.isNull(value, "The
     * value must be null");</pre>
     *
    ...
    /**
     * Assert that an object is not <code>null</code> . <pre class="code">Assert.notNull(clazz, "The
     * class must not be null");</pre>
     *
     * @param object  the object to check
     * @param message the exception message to use if the assertion fails
    ...
    public static <T> T argumentNotNull(T object, String argName) {
        if (object == null)
    ...
    /**
     * Assert that an object is not <code>null</code> . <pre class="code">Assert.notNull(clazz);</pre>
     *
     * @param object the object to check
     * @throws IllegalArgumentException if the object is <code>null</code>
     */
     ...
     * least one element. <pre class="code">Assert.notEmpty(array, "The array must have
     * elements");</pre>
     *
     ...
     * have at least one element. <pre class="code">Assert.notEmpty(collection, "Collection must
     * have elements");</pre>
     *
     ...
     *                  a ": " or ". " so that the function generate message looks ok when prepended
     *                  to it.
     * @throws IllegalArgumentException if the classes are not assignable
     */
     ...
     * assertion failure. <pre class="code">Assert.state(id == null, "The id property must not
     ...
     * <code>false</code>. <p>Call {@link #isTrue(boolean)} if you wish to throw {@link
     * IllegalArgumentException} on an assertion failure. <pre class="code">Assert.state(id ==
     * null);</pre>
     *
     * @param expression a boolean expression
