...
/**
 * Handle incoming replication event of new index for data type {@link IReplicationNode}
 *
 * @author anna
 * @since 8.0
 */
public interface IReplicationInDataTypeIndexAddedHandler {

    void inDataTypeAddIndex(IReplicationInContext context,
