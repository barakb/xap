 ...
 * @author GigaSpaces
 */
public abstract class SnapshotProxyAction<TSpaceProxy extends ISpaceProxy> {
    public abstract <T> ISpaceQuery<T> snapshot(TSpaceProxy spaceProxy, SnapshotProxyActionInfo actionInfo)
