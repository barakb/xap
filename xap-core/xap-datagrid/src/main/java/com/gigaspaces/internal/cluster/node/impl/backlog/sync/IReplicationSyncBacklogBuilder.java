...
public interface IReplicationSyncBacklogBuilder {
    /**
     * Create a backlog for a sync {@link IReplicationSourceGroup}
     *
     * @param groupConfig the group config
     * @return created backlog
     */
    IReplicationSyncGroupBacklog createSyncGroupBacklog(DynamicSourceGroupConfigHolder groupConfig);
}
