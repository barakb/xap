...
public class SynchronizationDonePacket extends AbstractGroupNameReplicationPacket<Object> {
    private static final long serialVersionUID = 1L;

    public SynchronizationDonePacket() {
    }

    public SynchronizationDonePacket(String groupName) {
        super(groupName);
    }
    ...
    public Object accept(IIncomingReplicationFacade incomingReplicationFacade) {
        ...
        targetGroup.synchronizationDone(getSourceLookupName(), getSourceUniqueId());
        return null;
    }
