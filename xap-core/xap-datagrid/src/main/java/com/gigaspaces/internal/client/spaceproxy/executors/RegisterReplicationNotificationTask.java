...
public class RegisterReplicationNotificationTask extends SystemTask<RegisterReplicationNotificationResponseInfo> {
    private static final long serialVersionUID = 1L;

    private RegisterReplicationNotificationRequestInfo _actionInfo;

    public RegisterReplicationNotificationTask() {
    }

    public RegisterReplicationNotificationTask(RegisterReplicationNotificationRequestInfo request) {
