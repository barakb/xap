...
public class MirrorDistributedTxnConfig {
    ...
    public MirrorDistributedTxnConfig setDistributedTransactionWaitTimeout(Long distributedTransactionWaitTimeout) {
    ...
    public MirrorDistributedTxnConfig setDistributedTransactionWaitForOperations(Long distributedTransactionWaitForOperations) {
    ...
    public MirrorDistributedTxnConfig setMonitorPendingOperationsMemory(Boolean monitorPendingOperationsMemory) {
