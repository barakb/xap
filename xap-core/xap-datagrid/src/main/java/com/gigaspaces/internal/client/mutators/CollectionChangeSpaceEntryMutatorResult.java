...
public class CollectionChangeSpaceEntryMutatorResult
        implements Externalizable {

    private static final long serialVersionUID = 1L;
    private boolean _collectionChanged;
    private int _size;
    ...
    public void writeExternal(ObjectOutput out) throws IOException {
        out.writeBoolean(_collectionChanged);
        out.writeInt(_size);
    }
    ...
    public void readExternal(ObjectInput in) throws IOException,
        ...
        _collectionChanged = in.readBoolean();
        _size = in.readInt();
    }
    ...
    public String toString() {
        return "CollectionChangeSpaceEntryMutatorResult [getSize()="
                + getSize() + ", isCollectionChanged()="
                + isCollectionChanged() + "]";
    }
