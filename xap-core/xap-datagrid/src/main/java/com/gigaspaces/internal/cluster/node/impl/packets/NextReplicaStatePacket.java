...
public class NextReplicaStatePacket
    ...
    public Object accept(IIncomingReplicationFacade incomingReplicationFacade) {
        CurrentStageInfo currentReplicaStage = incomingReplicationFacade.nextReplicaStage(_replicaRemoteContext);
        PlatformLogicalVersion sourceLogicalVersion = getSourceEndpointDetails().getPlatformLogicalVersion();
