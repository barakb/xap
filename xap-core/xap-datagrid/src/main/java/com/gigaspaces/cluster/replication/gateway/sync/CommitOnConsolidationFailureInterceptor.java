...
public class CommitOnConsolidationFailureInterceptor
        extends SynchronizationEndpointInterceptor {
    public static CommitOnConsolidationFailureInterceptor INSTANCE = new CommitOnConsolidationFailureInterceptor();
