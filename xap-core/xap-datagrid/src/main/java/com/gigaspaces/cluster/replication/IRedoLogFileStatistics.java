...
public interface IRedoLogFileStatistics {
    ...
    /**
     * @return used space in bytes which is external to the jvm
     */
    long getExternalStorageSpaceUsed();
    ...
    /**
     * @return number of packets held in storage
     */
    long getExternalStoragePacketsCount();
