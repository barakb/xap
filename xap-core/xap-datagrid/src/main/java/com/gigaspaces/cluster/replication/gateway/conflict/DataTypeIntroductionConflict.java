...
/**
 * A {@link ConflictCause} implementation for a type introduction operation conflict. <p> Occurs
 * when an attempt to introduce a new type to the target space fails. </p>
 *
 * @author idan
 * @since 8.0.3
 */
