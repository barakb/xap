...
public class OperationsBatchDataImpl
    ...
    public OperationsBatchDataImpl(IReplicationInBatchContext batchContext) {
        this._batchContext = batchContext;
    }

    @Override
    public DataSyncOperation[] getBatchDataItems() {
        DataSyncOperation[] operations = new DataSyncOperation[_batchContext.getPendingContext().size()];
