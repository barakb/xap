...
public interface RegisterTypeDescriptorConflict {
    /**
     * @return The type descriptor associated with the register type descriptor operation.
     */
    SpaceTypeDescriptor getTypeDescriptor();

    /**
     * @return The {@link ConflictCause} instance representing the conflict that occurred.
     */
