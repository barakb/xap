 ...
 *
 * e.g. <code> class MyPojo{ private int version;
 *
 * &amp;#064SpaceVersion public int getVersion(){ return version; }
 *
 * public void setVersion(int version){ this.version = version; } } </code>
 *
