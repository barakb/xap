...
public class DotnetGenericLinkedHashMap
        extends LinkedHashMap<Object, Object> implements IDoubleGenericType {
    ...
    public DotnetGenericLinkedHashMap(int capacity, float defaultLoadFactor,
