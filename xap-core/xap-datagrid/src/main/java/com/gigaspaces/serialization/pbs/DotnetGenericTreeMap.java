...
public class DotnetGenericTreeMap
        extends TreeMap<Object, Object> implements IDoubleGenericType {
    ...
    public DotnetGenericTreeMap(String keyGenericType, String valueGenericType) {
