...
/**
 * Thrown if an {@link UserManager} implementation encounters a non unique user.
 *
...
public class UserAlreadyExistsException extends SecurityException {
    ...
    /**
     * Creates a <code>UserAlreadyExistsException</code> with the specified detail message and
     * cause.
     *
    ...
    /**
     * Creates a <code>UserAlreadyExistsException</code> with the specified cause and a detail
