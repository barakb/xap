...
public class SpaceEvictionStrategyConfig {
    private final int _maxCacheSize;

    public SpaceEvictionStrategyConfig(int maxCacheSize) {
        this._maxCacheSize = maxCacheSize == 0 ? Integer.MAX_VALUE : maxCacheSize;
    }
