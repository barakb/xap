...
public class ClusterConfigurationException extends RemoteException {
    ...
    /**
     * Constructs a <code>ClusterConfigurationException</code>.
     */
    ...
    /**
     * Constructs a <code>ClusterConfigurationException</code> with the specified detail message.
     *
    ...
    /**
     * Constructs a <code>ClusterConfigurationException</code> with the specified detail message and
     * cause.
     *
     * @param str   the detail message
