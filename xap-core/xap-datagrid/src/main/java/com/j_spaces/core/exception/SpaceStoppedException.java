...
public class SpaceStoppedException extends SpaceUnavailableException {
    private static final long serialVersionUID = 4633433378894604434L;
     ...
     */
    public SpaceStoppedException(String spaceMemberName, String s) {
        super(spaceMemberName, s);
    }
}
