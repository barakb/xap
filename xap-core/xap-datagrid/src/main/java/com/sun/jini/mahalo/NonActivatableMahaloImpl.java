 ...
 * to start an implementation of Mahalo that is not activatable, but which will log its state
...
class NonActivatableMahaloImpl extends TxnManagerImpl {
    ...
    /**
     * Constructs a new instance of <code>TxnManagerImpl</code> that is not activatable, but which
     * will persist its state.
     *
