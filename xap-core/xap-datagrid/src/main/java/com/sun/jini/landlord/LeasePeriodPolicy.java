...
public interface LeasePeriodPolicy {
    ...
    public class Result {
        ...
        /**
         * Simple constructor to create a new <code>Result</code> object.
         *
     ...
     *
     * @param resource          the server side representation of the new lease that needs an
     *                          initial expiration and duration
     * @param requestedDuration the initial duration the requester of the resources would like. May
     *                          be <code>Lease.ANY</code>
     * @return A <code>Result</code> that holds both the expiration and duration.
     * @throws LeaseDeniedException     if the grant request is denied.
     * @throws IllegalArgumentException if the requested duration is not <code>Lease.ANY</code> and
     *                                  is negative.
     */
     ...
     *
     * @param resource          the server side representation of the lease that is being renewed
     * @param requestedDuration the duration the client is requesting. May be <code>Lease.ANY</code>.
     * @return A <code>Result</code> that holds both the expiration and duration.
