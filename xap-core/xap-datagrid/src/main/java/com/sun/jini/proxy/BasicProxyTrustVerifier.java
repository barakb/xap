 ...
 * its {@link #isTrustedObject isTrustedObject} method is equivalent in trust, content, and function
 * to the known trusted object that the trust verifier is constructed with. This trust verifier is
 * typically returned by an implementation of the {@link ServerProxyTrust#getProxyVerifier
...
public final class BasicProxyTrustVerifier
     ...
     * @throws IllegalArgumentException if the specified proxy is not an instance of {@link
     *                                  RemoteMethodControl} or {@link TrustEquivalence}
     */
    ...
    /**
     * Verifies trust in a proxy. Returns <code>true</code> if and only if the specified object is
     * an instance of {@link RemoteMethodControl} and invoking the {@link
     * TrustEquivalence#checkTrustEquivalence checkTrustEquivalence} method on a proxy that is this
     * verifier's proxy with the same method constraints of the specified object, passing the
     * specified object returns <code>true</code>.
     **/
    ...
    /**
     * @throws InvalidObjectException if the proxy is not an instance of {@link RemoteMethodControl}
