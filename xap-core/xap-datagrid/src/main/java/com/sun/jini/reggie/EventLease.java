...
public class EventLease extends RegistrarLease {
    ...
    /**
     * Returns EventLease or ConstrainableEventLease instance, depending on whether given server
    ...
    /**
     * Renews the event lease associated with an instance of this class. Each instance of this class
     * corresponds to a lease on an event registration for a particular client. This method renews
     * that lease on behalf of the client.
     *
     * @param duration the requested duration for the lease being renewed
     * @return long value representing the new duration that was granted for the renewed lease. Note
     * that the duration returned may be less than the duration requested.
     * @throws UnknownLeaseException indicates the lease does not exist; typically because the lease
     *                               has expired.
     */
