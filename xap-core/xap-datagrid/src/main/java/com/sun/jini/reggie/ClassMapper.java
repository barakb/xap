...
public class ClassMapper {
    ...
    /**
     * Returns a ServiceTypeBase descriptor for a class.  If needCodebase is false, the returned
     * descriptor's codebase may be null.
     */
     ...
     */
    public static ServiceType toServiceType(Class cls)
            throws MarshalException {
        if (cls != null)
    ...
    /**
     * Returns a EntryClassBase descriptor for a class.  If base is false, the returned descriptor's
     * codebase may be null, and the class need not be public and need not have a no-arg
     * constructor.
     */
    ...
    static class EntryField {
        ...
        /**
         * True if instances of the field need to be converted to MarshalledWrapper.  False if the
         * type of the field is String, Integer, Boolean, Character, Long, Float, Double, Byte, or
         * Short.
         */
