...
/**
 * Proxy for administering a registrar, returned from the getAdmin method of the main registrar
 * proxy.  Clients only see instances via the DiscoveryAdmin, JoinAdmin, DestroyAdmin and
 * ReferentUuid interfaces.
 *
