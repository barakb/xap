...
public class LandlordUtil {
    /**
     * Call <code>landlord.renew()</code> for each object in <code>cookie[]</code>, passing
     * <code>cookie[i]</code> and <code>durations[i]</code>.  Gather the results and exceptions into
     * a <code>RenewResults</code> object.
     *
     * @param landlord  A grantor of leases.
     * @param cookies   an array of <code>Uuid</code>s, each uniquely and universally identifying a
     *                  lease
     * @param durations an array of longs, each representing a duration in milliseconds that the
     *                  client wants the lease associated with the object from the corresponding
     *                  element of <code>cookies</code> renewed for.
     * @return A <code>RenewResults</code> object that contains the new duration of each lease that
    ...
    /**
     * Call <code>landlord.cancel()</code> for each object in <code>cookies[]</code>, passing
     * <code>cookies[i]</code>.
     *
     * @param landlord a grantor of leases
     * @param cookies  an array of <code>Uuid</code>s, each uniquely and universally identifying a
     *                 lease
     * @return If no exceptions are encountered, return <code>null</code>, otherwise, return a Map
     * that for each failed <code>cancel()</code> call maps the passed cookie object to the
