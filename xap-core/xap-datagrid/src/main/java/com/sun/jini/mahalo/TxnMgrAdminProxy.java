...
/**
 * A <tt>TxnMgrAdminProxy</tt> is a client-side proxy for a mailbox service. This interface provides
 * access to the administrative functions of the mailbox service as defined by the
 * <tt>TxnMgrAdmin</tt> interface.
 *
...
class TxnMgrAdminProxy implements DestroyAdmin, JoinAdmin,
    ...
    /**
     * Creates an administrable transaction manager proxy, returning an instance that implements
     ...
     * represents.
     *
     * @return the instance of <code>Uuid</code> that is associated with the resource this proxy
     * represents. This method will not return <code>null</code>.
    ...
    /**
     * When an instance of this class is deserialized, this method is automatically invoked. This
     * implementation of this method validates the state of the deserialized instance.
     *
     * @throws <code>InvalidObjectException</code> if the state of the deserialized instance of this
     *                                             class is found to be invalid.
     */
    ...
    /**
     * During deserialization of an instance of this class, if it is found that the stream contains
     * no data, this method is automatically invoked. Because it is expected that the stream should
     * always contain data, this implementation of this method simply declares that something must
     * be wrong.
     *
     * @throws <code>InvalidObjectException</code> to indicate that there was no data in the stream
     *                                             during deserialization of an instance of this
    ...
    static final class ConstrainableTxnMgrAdminProxy extends TxnMgrAdminProxy
        ...
        /**
         * Constructs a new <code>ConstrainableTxnMgrAdminProxy</code> instance. <p> For a
         * description of all but the <code>methodConstraints</code> argument (provided below),
         * refer to the description for the constructor of this class' super class.
         *
        ...
        /**
         * Returns a copy of the given server proxy having the client method constraints that result
         * after the specified method mapping is applied to the given client method constraints.
         */
        ...
        /**
         * Returns a new copy of this proxy class (<code>ConstrainableTxnMgrAdminProxy</code>) with
         * its client constraints set to the specified constraints. A <code>null</code> value is
        ...
        /**
         * Returns the client constraints placed on the current instance of this proxy class
         * (<code>ConstrainableTxnMgrAdminProxy</code>). The value returned by this method can be
         * <code>null</code>, which is interpreted as mapping all methods to empty constraints.
         */
        ...
        /**
         * Returns a proxy trust iterator that is used in <code>ProxyTrustVerifier</code> to
         * retrieve this object's trust verifier.
         */
        ...
        /**
         * Performs various functions related to the trust verification process for the current
         * instance of this proxy class, as detailed in the description for this class.
         *
         * @throws <code>InvalidObjectException</code> if any of the requirements for trust
         *                                             verification (as detailed in the class
