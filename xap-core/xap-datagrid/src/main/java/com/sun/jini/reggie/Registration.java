...
class Registration implements ServiceRegistration, ReferentUuid, Serializable {
    ...
    /**
     * Returns Registration or ConstrainableRegistration instance, depending on whether given server
    ...
    /**
     * Returns a string created from the proxy class name and the result of calling toString on the
     * contained lease.
     *
     * @return String
     */
