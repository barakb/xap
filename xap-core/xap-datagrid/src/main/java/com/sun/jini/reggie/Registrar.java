 ...
 * server. <p> The declared methods are pretty straightforward transformations of the
 * ServiceRegistrar and ServiceRegistration interfaces, with external classes (ServiceItem,
 * ServiceTemplate, ServiceMatches, Entry) converted to internal classes (Item, Template, Matches,
 * EntryRep).  In addition, there are methods for transformed Lease and LeaseMap interfaces, for
 * service and event leases.
 *
...
public interface Registrar
     ...
     * values of the specified field of those entries. The field name has been converted to an index
     * (fields numbered from super to subclass).
     *
