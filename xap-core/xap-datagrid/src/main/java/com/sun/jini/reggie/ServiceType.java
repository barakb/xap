...
/**
 * A ServiceType is a descriptor for a class, packaged up for transmission between client-side
...
class ServiceType implements Serializable {
    ...
    /**
     * Class name. If the class is generated by java.lang.reflect.Proxy, then the name is of the
     * form ";iface1;iface2;...;ifaceN".
     *
     * @serial
     */
    private String name;
    ...
    /**
     * Descriptor for the interfaces.  As a special case, interfaces is null for the descriptor for
     * java.lang.Object, and non-null otherwise. This avoids carrying a boolean isInterface around.
     *
     * @serial
     */
    protected ServiceType[] interfaces;
    /**
     * An instance containing only name, no supertype info. This is only used on the registrar side,
     * to minimize the amount of info transmitted back to clients.
     */
    ...
    /**
     * Returns true if this type is equal to <code>type</code> or if this type is equal to a
     * superclass of <code>type</code>.
     *
     * @param type Type to check if subclass of this class
     * @return true if <code>type</code> is a subclass of this type, false otherwise
    ...
    /**
     * Returns true if the object passed in is an instance of Type with the same type hash.  Returns
     * false otherwise.
     *
