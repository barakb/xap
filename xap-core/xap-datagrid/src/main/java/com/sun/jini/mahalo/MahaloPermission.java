 ...
 * server exported with a {@link net.jini.jeri.BasicJeriExporter}. This class can be passed to
 * {@link net.jini.jeri.BasicInvocationDispatcher}, and then used in security policy permission
 * grants. <p>
 *
 ...
 * syntax specified by {@link AccessPermission}. <p>
 *
 * The possible target names for use with a Mahalo server are specified in the package documentation
 * for <a href="package-summary.html"><code>com.sun.jini.mahalo</code></a>
 *
