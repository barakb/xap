...
abstract class RegistrarLease extends AbstractLease implements ReferentUuid {
    ...
    /**
     * Writes the default serializable field values for this instance, followed by the registrar's
    ...
    /**
     * Reads the default serializable field values for this instance, followed by the registrar's
     * service ID encoded as specified by the ServiceID.writeBytes method.  Verifies that the
     * deserialized field values are non-null.
     */
