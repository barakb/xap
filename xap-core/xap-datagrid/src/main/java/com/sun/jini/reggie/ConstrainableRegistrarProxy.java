...
final class ConstrainableRegistrarProxy
    ...
    /**
     * Creates new ConstrainableRegistrarProxy with given server reference, service ID and client
     * constraints.
     */
    ConstrainableRegistrarProxy(Object server,
    ...
    /**
     * Verifies that the client constraints for this proxy are consistent with those set on the
     * underlying server ref.
     */
