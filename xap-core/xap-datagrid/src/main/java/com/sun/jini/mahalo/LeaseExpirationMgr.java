...
public class LeaseExpirationMgr implements LeaseManager, WeakTable.KeyGCHandler {
     ...
     * <code>com.sun.jini.landlord.Landlord.cancel()<code> method less the
     * <code>RemoteException</code> in the throws clause. Mixing this interface into a
     * <code>Landlord</code> implementation allows the <code>LeaseExpirationMgr</code> to cancel
     * leases without having to deal with <code>RemoteException</code>.
     */
    public static interface Expirer {
        /**
         * Called by a LeaseExpirationMgr when it needs to expire a resource. The value of the
         * <code>cookie</code> parameter is obtained from <code>getCookie()</code> method of the
    ...
    /**
     * Create a <code>LeaseExpirationMgr</code> to aggressively expire the leases of the passed
     * landlord (implementing <code>Expirer</code> is trivial for a <code>Landlord</code>.
     */
    ...
    /**
     * Terminate the <code>LeaseExpirationMgr</code>, killing any threads it has started
     */
    void terminate() {
    ...
    /**
     * Schedule a leased resource to be reaped in the future. Called when a resource gets a lease,
     * or a lease is renewed.
     */
    ...
    /**
     * Objects that do the actually cancel the resource in question, stuck in
    ...
    private class Canceler implements Runnable {
        ...
        /**
         * Check the associated resource's expiration against the current time, canceling the
         * resource if its time has passed.  Synchronize on the resource before checking the
         * expiration time.
         */
        public void run() {
