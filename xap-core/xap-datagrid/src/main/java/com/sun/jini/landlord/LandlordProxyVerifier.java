...
final public class LandlordProxyVerifier
    ...
    /**
     * The canonical instance of the server reference. This instance will be used by the
     * <code>isTrusted</code> method as the known trusted object used to determine whether or not a
     ...
     * reference and server <code>Uuid</code>.
     *
     * @param landlord     the reference to the <code>Landlord</code> being used by the leases for
     ...
     *                     together.
     * @throws UnsupportedOperationException if <code>landlord</code> does not implement both {@link
     *                                       RemoteMethodControl} and {@link TrustEquivalence}
    ...
    /**
     * Returns <code>true</code> if the specified proxy object (that is not yet known to be trusted)
     * is equivalent in trust, content, and function to the canonical server reference this object
     * was constructed with; otherwise returns <code>false</code>.
     *
     * @param obj proxy object that will be compared to this class's stored canonical proxy to
     *            determine whether or not the given proxy object is equivalent in trust, content,
     *            and function.
     * @return <code>true</code> if the specified object (that is not yet known to be trusted) is
     * equivalent in trust, content, and function to the canonical inner proxy object referenced in
     * this class; otherwise returns <code>false</code>.
    ...
    /**
     * Verifies that the server reference implements <code>TrustEquivalence</code>.
     */
