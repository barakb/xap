...
class TransientRegistrarImpl extends RegistrarImpl {
    ...
    /**
     * Constructs a TransientRegistrarImpl based on a configuration obtained using the provided
     * arguments.  If lifeCycle is non-null, then its unregister method is invoked during service
     * shutdown.
     */
