...
/**
 * This class holds a <code>MarshalledObject</code> that can be stored persistently.  When you
 * invoke <code>get</code>, the object is deserialized, its value cached in this object, and then
 * returned. Subsequent calls to <code>get</code> return that value.  This lets you store the object
 * and hold it around, waiting until it is actually deserializable, since it may not be at any given
 * time due to various factors, such as the codebase being unavailable.
 *
...
public class StorableObject implements java.io.Serializable {
    ...
    /**
     * Create a <code>StorableObject</code> that will hold <code>obj</code> in a
     ...
     * reference in hand.
     *
     * @throws java.rmi.RemoteException Problems re-establishing connection with remote object
     */
