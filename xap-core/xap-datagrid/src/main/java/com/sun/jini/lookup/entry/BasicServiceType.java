...
/**
 * An implementation of ServiceType that uses ResourceBundles.  If the value of the public field
 * type contains at least one dot ('.'), then the value of the field is used as the name of the
 * ResourceBundle. Otherwise, the name of the ResourceBundle is obtained by prefixing
 * "net.jini.lookup.entry.servicetype." to the value of the public field. The default locale is
 * used.
 *
