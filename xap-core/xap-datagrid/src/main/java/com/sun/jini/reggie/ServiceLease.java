...
/**
 * A ServiceLease is a proxy for a service registration lease at a registrar. Clients only see
 * instances via the Lease interface.
 *
...
class ServiceLease extends RegistrarLease {
    ...
    /**
     * Returns ServiceLease or ConstrainableServiceLease instance, depending on whether given server
