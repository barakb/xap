...
public class EventDescriptor extends AbstractEntry {
    ...
    /**
     * Construct an EventDescriptor with a class and long event ID. The eventID will be turned into
     * a Long
     */
    public EventDescriptor(Class eventClass, long eventID) {
        this(eventClass, new Long(eventID));
    }
     ...
     *
     * @return The following logic determines EventDescriptor matching semantics : <ul> <li>If the
     * provided EventDescriptor properties <code>eventID</code> and <code>eventClass</code> are
     * <code>null</code>, return <code>true</code>. <li>If the provided EventDescriptor property
     * <code>eventID</code> is <code>null</code>, and the <code>eventClass</code> property is not
     * <code>null</code>, return whether the provided EventDescriptor property
     * <code>eventClass</code> is equal to the <code>eventClass</code> property <li>If the
     * <code>eventID</code> property is <code>null</code>, return <code>false</code>. <li>If the
     * <code>eventID</code> property is not <code>null</code>, and the provided EventDescriptor
     * <code>eventID</code> property is not <code>null</code>, return whether the provided
     * EventDescriptor property <code>eventID</code> is equal to the <code>eventID</code> property
     * </ul>
     * @throws NullPointerException if the the provided EventDescriptor is <code>null</code>
     */
