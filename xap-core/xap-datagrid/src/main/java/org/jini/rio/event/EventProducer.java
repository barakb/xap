...
public interface EventProducer extends Remote {
    /**
     * The register method creates a leased {@link net.jini.core.event.EventRegistration} for the
     ...
     * @param handback   A MarshalledObject referencing a handback object to be used with Event
     *                   notification
     ...
     * @throws UnknownEventException if the service does not produce events described by the
     *                               EventDescriptor
