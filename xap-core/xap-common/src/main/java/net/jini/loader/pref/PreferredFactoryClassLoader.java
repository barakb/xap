...
/**
 * Class loader to wrap the preferred class loader so that loadClass checks package access. Similar
 * to the class loaders returned by URLClassLoader.newInstance.
 *
