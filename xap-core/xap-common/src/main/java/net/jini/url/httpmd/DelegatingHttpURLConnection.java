...
/**
 * An HTTP URL connection that delegates all operations defined by HttpURLConnection and
 * URLConnection.
 *
...
class DelegatingHttpURLConnection extends HttpURLConnection {
    ...
    /**
     * Creates an HttpURLConnection for the specified URL that delegates all operations to the value
     * of the delegateConnection field, which should be set separately.
     */
