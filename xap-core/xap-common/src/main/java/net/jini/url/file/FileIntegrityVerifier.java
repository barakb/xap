 ...
 * Security.verifyCodebaseIntegrity}. <p> Do not use this verifier if your operating system is
 * configured to mount remote file systems and the underlying file system protocols do not provide
 * adequate data integrity or authentication of the remote hosts.
 *
...
public class FileIntegrityVerifier implements IntegrityVerifier {
    /**
     * Returns <code>true</code> if the specified URL uses the "file" protocol and the host is
     * <code>null</code>, empty, "~", or "localhost"; returns <code>false</code> otherwise.
     *
