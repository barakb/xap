...
/**
 * This class is the supertype of all entries that can be stored in a Jini(TM) Lookup service. <p>
 * Each field of an entry must be a public reference (object) type. You cannot store primitive types
 * in fields of an <code>Entry</code>.  An <code>Entry</code> may have any number of methods or
