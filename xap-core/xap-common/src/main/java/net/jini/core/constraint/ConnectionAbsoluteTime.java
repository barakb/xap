 ...
 * The precise meaning of this will vary across communication mechanisms, but in the typical case of
 * {@link java.net.Socket}-based communication, the intention is that this constraint controls the
 * timeout parameter of the {@link java.net.Socket#connect(java.net.SocketAddress, int) connect}
 * method.
 *
...
public final class ConnectionAbsoluteTime
     ...
     *
     * @param time the deadline for connection establishment in milliseconds from midnight, January
     *             1, 1970 UTC
     */
     ...
     *
     * @return the deadline for connection establishment in milliseconds from midnight, January 1,
     * 1970 UTC
     */
    public long getTime() {
        return time;
