 ...
 * <code>NestableTransactionManager</code> servers for use with transaction participants that
...
public interface NestableTransaction extends Transaction {
     ...
     * @throws UnknownTransactionException if the parent transaction is unknown to the parent
     *                                     transaction manager, either because the transaction ID is
     *                                     incorrect or because the transaction is no longer active
     *                                     and its state has been discarded by the manager.
     * @throws CannotJoinException         if the parent transaction is known to the manager but is
     *                                     no longer active.
