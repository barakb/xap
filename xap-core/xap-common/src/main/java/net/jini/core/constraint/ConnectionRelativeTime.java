 ...
 * typical case of {@link java.net.Socket}-based communication, the intention is that this
 * constraint controls the timeout parameter of the {@link java.net.Socket#connect(java.net.SocketAddress,
 * int) connect} method. <p> The duration is translated into an absolute end time at the point of a
...
public final class ConnectionRelativeTime
    ...
    /**
     * Returns a {@link ConnectionAbsoluteTime} instance with time obtained by adding the specified
     * base time argument to the duration value from this instance. If the addition results in
     * overflow, a time value of <code>Long.MAX_VALUE</code> is used.
     */
