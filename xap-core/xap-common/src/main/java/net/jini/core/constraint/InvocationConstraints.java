 ...
 * constraint or the contents of the constraint, then the constraint cannot be satisfied. <p> Note
 * that it is possible for an instance of this class to contain both requirements that conflict with
 * each other, and preferences that conflict with each other and with requirements.
 *
...
public final class InvocationConstraints implements Serializable {
    ...
    /**
     * Creates an instance that has the first constraint, <code>req</code>, added as a requirement
     * if it is a non-<code>null</code> value, and has the second constraint, <code>pref</code>,
     * added as a preference if it is a non-<code>null</code> value and is not a duplicate of the
     * requirement.
     *
    ...
    /**
     * Creates an instance that has all of the constraints from the first array, <code>reqs</code>,
     * added as requirements if the array is a non-<code>null</code> value, and has all of the
     * constraints from the second array, <code>prefs</code>, added as preferences if the array is a
     * non-<code>null</code> value. Duplicate requirements, duplicate preferences, and preferences
     * that are duplicates of requirements are all removed. The arguments passed to the constructor
     * are neither modified nor retained; subsequent changes to those arguments have no effect on
     * the instance created.
     *
     * @param reqs  requirements, or <code>null</code>
     * @param prefs preferences, or <code>null</code>
     * @throws NullPointerException if any element of an argument is <code>null</code>
     */
    ...
    /**
     * Creates an instance that has all of the constraints from the first collection,
     * <code>reqs</code>, added as requirements if the collection is a non-<code>null</code> value,
     * and has all of the constraints from the second collection, <code>prefs</code>, added as
     * preferences if the collection is a non-<code>null</code> value. Duplicate requirements,
     * duplicate preferences, and preferences that are duplicates of requirements are all removed.
     * The arguments passed to the constructor are neither modified nor retained; subsequent changes
     * to those arguments have no effect on the instance created.
     *
     * @param reqs  requirements, or <code>null</code>
     * @param prefs preferences, or <code>null</code>
     * @throws NullPointerException     if any element of an argument is <code>null</code>
     * @throws IllegalArgumentException if any element of an argument is not an instance of
    ...
    /**
     * Creates an instance containing the specified requirements and preferences. Reqidx and prefidx
     * indicate how many of the initial elements in each array are known to have been reduced
     * (meaning they came from an existing instance of this class), but prefidx must be zero if
     * reqidx is non-zero but reqidx is less than the total number of requirements. Rel contains the
     * flags for which constraints are relative.
     */
    ...
    /**
     * Replaces null fields with empty arrays, eliminates duplicates, and sets flags indicating
     * which constraints are relative.
     */
    private void reduce() {
        if (reqs == null) {
            reqs = empty;
    ...
    /**
     * Checks for nulls and eliminates duplicates. Reqidx and prefidx indicate how many of the
     * initial elements in each array are known to have been reduced (meaning they came from an
     * existing instance of this class), but prefidx must be zero if reqidx is non-zero but reqidx
     * is less than the total number of requirements.
     */
    ...
    /**
     * Returns true if the specified constraint either implements RelativeTimeConstraint or is an
     * instance of ConstraintAlternatives with elements that implement RelativeTimeConstraint, and
     * false otherwise.
     */
    ...
    /**
     * Returns an instance of this class that has all of the requirements from each
     * non-<code>null</code> argument added as requirements and has all of the preferences from each
     * non-<code>null</code> argument added as preferences. Duplicate requirements, duplicate
     * preferences, and preferences that are duplicates of requirements are all removed.
     *
     * @param constraints1 constraints, or <code>null</code>
     * @param constraints2 constraints, or <code>null</code>
     * @return an instance of this class that has all of the requirements from each
     * non-<code>null</code> argument added as requirements and has all of the preferences from each
     * non-<code>null</code> argument added as preferences
     */
    ...
    /**
     * Returns an instance of this class equal to the result of taking the requirements and
     * preferences in this instance, replacing each constraint that is an instance of {@link
     * RelativeTimeConstraint} with the result of invoking that constraint's
     * <code>makeAbsolute</code> method with the specified base time, and creating a new instance of
     * this class with duplicate requirements, duplicate preferences, and preferences that are
     * duplicates of requirements all removed.
     *
     * @param baseTime an absolute time, specified in milliseconds from midnight, January 1, 1970
     *                 UTC
     * @return an instance of this class equal to the result of taking the requirements and
     * preferences in this instance, replacing each constraint that is an instance of
     * <code>RelativeTimeConstraint</code> with the result of invoking that constraint's
     * <code>makeAbsolute</code> method with the specified base time, and creating a new instance of
     * this class with duplicate requirements, duplicate preferences, and preferences that are
     * duplicates of requirements all removed
     */
    ...
    /**
     * Returns an instance of this class constructed from all of the same requirements and
     * preferences as this instance, but with every constraint that is an instance of {@link
     * RelativeTimeConstraint} replaced by the result of invoking the constraint's
     * <code>makeAbsolute</code> method with the current time (as given by {@link
     * System#currentTimeMillis System.currentTimeMillis}). Duplicate requirements, duplicate
     * preferences, and preferences that are duplicates of requirements are all removed.
     *
     * @return an instance of this class constructed from all of the same requirements and
     * preferences as this instance, but with every constraint that is an instance of
     * <code>RelativeTimeConstraint</code> replaced by the result of invoking the constraint's
    ...
    /**
     * Returns an immutable set of all of the requirements. Any attempt to modify this set results
    ...
    /**
     * Returns an immutable set of all of the preferences. Any attempt to modify this set results in
    ...
    /**
     * Returns <code>true</code> if the instance has no requirements and no preferences; returns
     * <code>false</code> otherwise.
     *
     * @return <code>true</code> if the instance has no requirements and no preferences;
     * <code>false</code> otherwise
     */
    ...
    /**
     * Two instances of this class are equal if they have the same requirements and the same
     * preferences. This method is a sufficient substitute for {@link net.jini.security.proxytrust.TrustEquivalence#checkTrustEquivalence
     ...
     *
     * @throws InvalidObjectException if the requirements or preferences arrays are
     *                                <code>null</code>, or any element is <code>null</code>, or if
     *                                there are duplicate requirements, duplicate preferences, or
    ...
    /**
     * Verifies that the array is non-null, the elements are all non-null, and there are no
     * duplicates.
     */
