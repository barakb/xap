...
public class LeaseMapException extends LeaseException {
     ...
     * @param exceptionMap the <tt>Map</tt> object on which the exception occurred
     * @throws NullPointerException     if <code>exceptionMap</code> is <code>null</code> or
     *                                  contains a <code>null</code> key or a <code>null</code>
     *                                  value
     * @throws IllegalArgumentException if <code>exceptionMap</code> contains any key which is not
     *                                  an instance of {@link Lease}, or any value which is not an
     *                                  instance of <code>Throwable</code>
     */
    ...
    /**
     * @throws InvalidObjectException if <code>exceptionMap</code> is <code>null</code>, contains
     *                                any key which is not an instance of {@link Lease}, or contains
     *                                any value which in not an instance of <code>Throwable</code>
     */
