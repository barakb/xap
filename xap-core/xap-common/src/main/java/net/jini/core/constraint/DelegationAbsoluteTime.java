 ...
 * any earlier than this time <li><code>maxStart</code> - delegation must be permitted from this
 * time onwards <li><code>minStop</code> - delegation must be permitted up until at least this time
 * <li><code>maxStop</code> - delegation must not be permitted after this time </ul> To accommodate
 * clock skew between systems, it may be desirable to specify start times that are earlier than the
 * current time. <p> The use of an instance of this class does not directly imply a {@link
 * ClientAuthentication#YES} constraint or a {@link Delegation#YES} constraint; those must be
 ...
 * {@link ClientAuthentication#NO} or {@link Delegation#NO}.
 *
...
public final class DelegationAbsoluteTime
     ...
     *
     * @param minStart the minimum start time in milliseconds from midnight, January 1, 1970 UTC
     * @param maxStart the maximum start time in milliseconds from midnight, January 1, 1970 UTC
     * @param minStop  the minimum stop time in milliseconds from midnight, January 1, 1970 UTC
     * @param maxStop  the maximum stop time in milliseconds from midnight, January 1, 1970 UTC
    ...
    /**
     * Creates a constraint with the specified dates. The arguments passed to the constructor are
     * neither modified nor retained; subsequent changes to those arguments have no effect on the
     * instance created.
     *
     ...
     * @throws IllegalArgumentException if <code>minStart</code> is later than <code>maxStart</code>,
     *                                  or <code>maxStart</code> is later than <code>minStop</code>,
     *                                  or <code>minStop</code> is later than <code>maxStop</code>
     */
     ...
     *
     * @return the minimum start time in milliseconds from midnight, January 1, 1970 UTC
     */
     ...
     *
     * @return the maximum start time in milliseconds from midnight, January 1, 1970 UTC
     */
     ...
     *
     * @return the minimum stop time in milliseconds from midnight, January 1, 1970 UTC
     */
     ...
     *
     * @return the maximum stop time in milliseconds from midnight, January 1, 1970 UTC
     */
     ...
     * <code>maxStart</code> is less than or equal to <code>minStop</code>, and <code>minStop</code>
     * is less than or equal to <code>maxStop</code>.
     *
