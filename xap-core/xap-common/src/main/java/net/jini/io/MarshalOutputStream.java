 ...
 * {@link RMIClassLoader}).  A <code>MarshalOutputStream</code> writes data that is intended to be
...
public class MarshalOutputStream
    ...
    //Used for backward compatibility, where codebase is needed.
    private final static boolean USE_CODE_BASE = Boolean.getBoolean("net.jini.io.useCodeBase");
     ...
     *
     * @param cl the class to annotate
     * @return the class CodeBase or null
     */
