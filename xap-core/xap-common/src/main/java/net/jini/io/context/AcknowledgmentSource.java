...
public interface AcknowledgmentSource {
    ...
    /**
     * Registers the specified listener as interested in receiving an acknowledgment that the remote
     * call's result data has been processed by the client.  Multiple listeners may be registered
     * with this object.
     *
     * <p>The implementation of this interface may refuse a registration, such as if the remote
     * call's result data has already been written.  This method returns <code>true</code> if the
     * listener was successfully registered, and <code>false</code> if the registration was
     * refused.
     *
     * @param listener the listener to register
     * @return <code>true</code> if the listener was successfully registered, and <code>false</code>
    ...
    /**
     * A callback object for registering with an {@link AcknowledgmentSource} server context element
    ...
    interface Listener {
         ...
         *
         * <p>If <code>received</code> is <code>true</code>, then a positive acknowledgment has been
         * received that the remote call's result data has been processed by the client.
         *
         * If <code>received</code> is <code>false</code>, then the implementation of this interface
         ...
         *
         * @param received <code>true</code> if an acknowledgment was received, and
         *                 <code>false</code> if no acknowledgment will be received
         **/
