...
/**
 * Defines an interface for obtaining objects needed to configure applications, such as {@link
 * Exporter} or {@link ProxyPreparer} instances, or other application-specific objects, from
 * configuration files, databases, or other sources. Configuration entries are identified by a
 * <code>component</code> and a <code>name</code>. Methods that retrieve entries can specify a
 * default value to return in case the entry is not found, and supply data to use when computing the
 * value of the entry. <p>
 *
 ...
 * requiring code modifications. Applications should normally use {@link ConfigurationProvider} to
 * obtain <code>Configuration</code> instances, rather than referencing implementation classes
...
public interface Configuration {
    /**
     * An object to pass for <code>defaultValue</code> in calls to <code>getEntry</code> to specify
     * no default value.
     *
    ...
    /**
     * An object to pass for <code>data</code> in calls to <code>getEntry</code> to specify no
     * data.
     *
     * @see #getEntry(String, String, Class, Object, Object)
     */
     ...
     *
     * Calling this method is equivalent to calling <code>{@link #getEntry(String, String, Class,
     * Object, Object) getEntry}(component, name, type, {@link #NO_DEFAULT}, {@link
     * #NO_DATA})</code>.
     *
     ...
     * @throws ConfigurationException   if a matching entry is found but a problem occurs creating
     ...
     *
     * Calling this method is equivalent to calling <code>{@link #getEntry(String, String, Class,
     * Object, Object) getEntry}(component, name, type, defaultValue, {@link #NO_DATA})</code>.
     *
     * @param component    the component being configured
     * @param name         the name of the entry for the component
     * @param type         the type of the object to be returned
     * @param defaultValue the object to return if no matching entry is found, or
     *                     <code>NO_DEFAULT</code> to specify no default
     * @return an object created using the information in the entry matching <code>component</code>
     ...
     * @throws NoSuchEntryException     if no matching entry is found and <code>defaultValue</code>
     *                                  is <code>NO_DEFAULT</code>
     * @throws ConfigurationException   if a matching entry is found but a problem occurs creating
     *                                  the object for the entry, or if <code>type</code> is a
     *                                  reference type and the result for the matching entry is not
     *                                  either <code>null</code> or an instance of
     ...
     *                                  not a valid <i>QualifiedIdentifier</i>; or if
     *                                  <code>name</code> is not <code>null</code> and is not a
     *                                  valid <i>Identifier</i>; or if <code>type</code> is a
     *                                  reference type and <code>defaultValue</code> is not
     *                                  <code>NO_DEFAULT</code>, <code>null</code>, or an instance
     *                                  of <code>type</code>; or if <code>type</code> is a primitive
     *                                  type and <code>defaultValue</code> is not
     *                                  <code>NO_DEFAULT</code> or an instance of the associated
     *                                  wrapper class
     ...
     * package name of the object being configured. The <code>name</code> identifies which of
     * possibly several entries are available for the given component. The value of
     * <code>name</code> must be an <i>Identifier</i>, as defined in the JLS.
     *
     * @param component    the component being configured
     * @param name         the name of the entry for the component
     * @param type         the type of the object to be returned
