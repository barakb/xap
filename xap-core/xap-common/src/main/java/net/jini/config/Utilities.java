...
class Utilities {
    ...
    /**
     * Class loader whose parent is the bootstrap class loader, and provides no resources of its
     * own, for finding resources in the bootstrap class loader.
     */
    static final ClassLoader bootstrapResourceLoader =
            URLClassLoader.newInstance(new URL[0], null);

    /**
     * Returns the primitive type associated with a wrapper type or null if the argument is not a
     * wrapper type.
     *
