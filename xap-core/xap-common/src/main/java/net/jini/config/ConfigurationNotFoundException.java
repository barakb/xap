...
/**
 * Thrown if a configuration source location specified when creating a <code>Configuration</code> is
 * not found, including if <code>null</code> is specified for provider options and the
 ...
 * calling {@link #getCause getCause}. Note that any instance of <code>Error</code> thrown while
...
public class ConfigurationNotFoundException extends ConfigurationException {
     ...
     * be an instance of <code>Error</code>.
     *
     * @param s the detail message
