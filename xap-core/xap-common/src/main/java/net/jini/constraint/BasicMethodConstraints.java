...
/**
 * Basic implementation of {@link MethodConstraints}, allowing limited wildcard matching on method
 ...
 * class should be obtained from a {@link net.jini.config.Configuration} rather than being
...
public final class BasicMethodConstraints
    ...
    public static final class MethodDesc implements Serializable {
        ...
        /**
         * @serialField name String The name of the method, with prefix or suffix '*' permitted if
         * <code>types</code> is <code>null</code>, or <code>null</code> for a descriptor that
         * matches all methods (in which case <code>types</code> must also be <code>null</code>).
         * @serialField types Class[] The parameter types for the specified method, or
         * <code>null</code> for wildcard parameter types.
         * @serialField constraints InvocationConstraints The non-empty constraints for the
         * specified method or methods, or <code>null</code> if there are no constraints.
         */
        private static final ObjectStreamField[] serialPersistentFields = {
        ...
        /**
         * The name of the method, with prefix or suffix '*' permitted if <code>types</code> is
         * <code>null</code>, or <code>null</code> for a descriptor that matches all methods (in
         * which case <code>types</code> must also be <code>null</code>.
         */
        final String name;
        /**
         * The formal parameter types of the method, in declared order, or <code>null</code> for
         * wildcard parameter types.
         */
        final Class[] types;
        /**
         * The non-empty constraints for the specified method or methods, or <code>null</code> if
         * there are no constraints.
         */
        final InvocationConstraints constraints;

        /**
         * Creates a descriptor that only matches methods with exactly the specified name and
         * parameter types. The constraints can be <code>null</code>, which is treated the same as
         * an empty instance. The array passed to the constructor is neither modified nor retained;
         * subsequent changes to that array have no effect on the instance created.
         *
         * @param name        the name of the method
         * @param types       the formal parameter types of the method, in declared order
         * @param constraints the constraints, or <code>null</code>
         * @throws NullPointerException     if <code>name</code> or <code>types</code> is
         *                                  <code>null</code> or any element of <code>types</code>
         *                                  is <code>null</code>
         * @throws IllegalArgumentException if <code>name</code> is not a syntactically valid method
         *                                  name
         */
        ...
        /**
         * Creates a descriptor that matches all methods with names that equal the specified name or
         * that match the specified pattern, regardless of their parameter types. If the specified
         * name starts with the character '*', then this descriptor matches all methods with names
         * that end with the rest of the specified name. If the specified name ends with the
         * character '*', then this descriptor matches all methods with names that start with the
         * rest of the specified name. Otherwise, this descriptor matches all methods with names
         * that equal the specified name. The constraints can be <code>null</code>, which is treated
         * the same as an empty instance.
         *
         * @param name        the name of the method, with a prefix or suffix '*' permitted for
         *                    pattern matching
         * @param constraints the constraints, or <code>null</code>
         * @throws NullPointerException     if <code>name</code> is <code>null</code>
         * @throws IllegalArgumentException if <code>name</code> does not match any syntactically
         *                                  valid method name
         */
        ...
        /**
         * Verifies that the name is a syntactically valid method name, or (if types is null) if the
         * name is a syntactically valid method name with a '*' appended or could be constructed
         * from some syntactically valid method name containing more than two characters by
         * replacing the first character of that name with '*', and verifies that none of the
         * elements of types are null.
         */
        private void check() {
        ...
        /**
         * Creates a default descriptor that matches all methods. The constraints can be
        ...
        /**
         * Returns the name of the method, with a prefix or suffix '*' if the name is a pattern, or
         * <code>null</code> if this descriptor matches all methods.
         *
         * @return the name of the method, with a prefix or suffix '*' if the name is a pattern, or
         * <code>null</code> if this descriptor matches all methods
         */
        ...
        /**
         * Returns the parameter types, or <code>null</code> if this descriptor matches all
         * parameter types or all methods. Returns a new non-<code>null</code> array every time it
         * is called.
         *
         * @return the parameter types, or <code>null</code> if this descriptor matches all
        ...
        /**
         * Two instances of this class are equal if they have the same name, the same parameter
         ...
         *
         * @throws InvalidObjectException if <code>types</code> is non-<code>null</code> and
         *                                <code>name</code> is either <code>null</code> or is not a
         *                                syntactically valid method name; or if <code>types</code>
         *                                is <code>null</code> and <code>name</code> is neither a
         *                                syntactically valid method name, a syntactically valid
         *                                method name with a '*' appended, nor a name constructed
         *                                from some syntactically valid method name containing more
         *                                than two characters by replacing the first character of
         *                                that name with '*'; or if any element of
         *                                <code>types</code> is <code>null</code>; or if
         *                                <code>constraints</code> is non-<code>null</code> but
         *                                empty
         */
    ...
    /**
     * Creates an instance with the specified ordered array of descriptors. The {@link
     * #getConstraints getConstraints} method searches the descriptors in the specified order. For
     ...
     * @throws NullPointerException     if the argument is <code>null</code> or any element of the
     *                                  argument is <code>null</code>
     * @throws IllegalArgumentException if the descriptors array is empty, or if any descriptor is
    ...
    /**
     * Throws IllegalArgumentException if the descriptors array is empty, or if any descriptor is
     * preceded by another descriptor that matches at least the same methods. Throws
    ...
    /**
     * Creates an instance that maps all methods to the specified constraints. The constraints can
     * be <code>null</code>, which is treated the same as an empty instance. Calling this
     * constructor is equivalent to constructing an instance of this class with an array containing
     * a single default descriptor constructed with the specified constraints.
     *
     * @param constraints the constraints, or <code>null</code>
     */
    ...
    /**
     * Returns the constraints for the specified remote method as a non-<code>null</code> value.
     * Searches the descriptors in order, and returns the constraints in the first descriptor that
     * matches the method, or an empty constraints instance if there is no match.
     *
    ...
    /**
     * Returns the descriptors. Returns a new non-<code>null</code> array every time it is called.
     *
     ...
     *
     * @throws InvalidObjectException if any descriptor is <code>null</code>, or the descriptors
     *                                array is empty, or if any descriptor is preceded by another
     *                                descriptor that matches at least the same methods
     */
    private void readObject(ObjectInputStream s)
            throws IOException, ClassNotFoundException {
        s.defaultReadObject();
    ...
    /**
     * If the exception is a NullPointerException or IllegalArgumentException, wrap it in an
     * InvalidObjectException and throw that, otherwise rethrow the exception as is.
     */
