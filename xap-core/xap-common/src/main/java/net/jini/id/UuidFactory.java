 ...
 *
 * <p>Included are methods to create a <code>Uuid</code> with a given 128-bit value or a string
 * representation of such a value, to generate new <code>Uuid</code> values, and to read a binary
...
public final class UuidFactory {
     ...
     *
     * <p>This method can be used to create a <code>Uuid</code> with a value that has been
     * previously generated, perhaps by an external mechanism.
     *
    ...
    /**
     * Creates a new <code>Uuid</code> with the 128-bit value represented by the specified string.
     *
     * <p>The supplied string representation must be in the format defined by {@link Uuid#toString
     * Uuid.toString} except that uppercase hexadecimal digits are allowed.
     *
     * @param s the string representation to create the <code>Uuid</code> with
     * @return a <code>Uuid</code> with the value represented by the given string
    ...
    /**
     * Generates a new <code>Uuid</code> with 122 bits of its value produced from a
     * cryptographically strong random sequence.
     *
     * <p>The value of a <code>Uuid</code> returned by this method is computationally difficult to
     * guess and is highly likely to be unique with respect to all other <code>Uuid</code> values
     * returned by this method over space and time.
     *
     * <p>Specifically, this method creates a new <code>Uuid</code> with the a <code>variant</code>
     * field of <code>0x2</code>, a <code>version</code> field of <code>0x4</code>, and the
     * remaining 122 bits of its value produced from a cryptographically strong random sequence.
     *
    ...
    /**
     * Creates a new <code>Uuid</code> with the 128-bit value obtained by unmarshalling a binary
     * representation from the supplied <code>InputStream</code>.
     *
     * <p>Specifically, this method reads 16 bytes from the stream, and then it creates a new
     * <code>Uuid</code> with the 128-bit value represented by those bytes interpreted in network
     * (big-endian) byte order.
     *
     * @param in the <code>InputStream</code> to read the <code>Uuid</code> from
     * @return a <code>Uuid</code> with the value unmarshalled from the stream
    ...
    /**
     * Extends <code>Uuid</code> trivially, in order to be a preferred class and retain the original
     * codebase annotation.
     **/
