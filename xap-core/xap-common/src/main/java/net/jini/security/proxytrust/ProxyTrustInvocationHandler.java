 ...
 * {@link ProxyTrustVerifier}. This invocation handler contains both an underlying main proxy and a
 * bootstrap proxy; the main proxy is not expected to be considered trusted directly by clients, but
 * the bootstrap proxy is. The main proxy must be an instance of both {@link RemoteMethodControl}
 * and {@link TrustEquivalence}, and the bootstrap proxy must be an instance of {@link ProxyTrust},
 * <code>RemoteMethodControl</code>, and <code>TrustEquivalence</code>. This invocation handler
 * handles most method invocations by delegating to the main proxy. The bootstrap proxy is produced
 * by the iterator returned by the {@link #getProxyTrustIterator getProxyTrustIterator} method, as
...
public final class ProxyTrustInvocationHandler
     ...
     * @throws IllegalArgumentException if the main proxy is not an instance of {@link
     *                                  TrustEquivalence}, or the bootstrap proxy is not an instance
     ...
     * returns the return value, if any. <p> If the specified method is <code>Object.equals</code>,
     * returns <code>true</code> if the argument (<code>args[0]</code>) is an instance of a dynamic
     * proxy class (that is, a class generated by {@link Proxy}) that implements the same interfaces
     * as the specified proxy and this invocation handler is equal to the invocation handler of that
     * argument, and returns <code>false</code> otherwise. <p> If the specified method is
     * <code>Object.toString</code>, returns a string representation of the specified proxy object.
     * <p> If the specified method is <code>Object.hashCode</code>, returns a hash code for the
     * specified proxy object. <p> If the specified method is {@link RemoteMethodControl#setConstraints
     * RemoteMethodControl.setConstraints}, returns a new proxy (an instance of the same class as
     ...
     * handler. <p> If the specified method is {@link TrustEquivalence#checkTrustEquivalence
     * TrustEquivalence.checkTrustEquivalence}, returns <code>true</code> if the argument
     * (<code>args[0]</code>) is an instance of a dynamic proxy class that implements the same
     * interfaces as the specified proxy and calling the {@link #checkTrustEquivalence
     * checkTrustEquivalence} method of this invocation handler with the invocation handler of that
     * argument returns <code>true</code>, and returns <code>false</code> otherwise. <p> For all
     * other methods, returns the object obtained by delegating to the main proxy: the specified
     * method is reflectively invoked on the main proxy with the specified arguments, unless the
     * method's declaring class is not public but the main proxy is an instance of that declaring
     * class and the main proxy's class is public, in which case the corresponding method of the
     * main proxy's class is reflectively invoked instead. <p> The semantics of this method are
     * unspecified if the arguments could not have been produced by an instance of some valid
     * dynamic proxy class containing this invocation handler.
     *
     * @param proxy  the proxy object
     * @param method the method being invoked
     * @param args   the arguments to the specified method
     * @return the value returned by executing the specified method on the specified proxy with the
     * specified arguments, or <code>null</code> if the method has <code>void</code> return type
     * @throws Throwable                the exception thrown by executing the specified method
     * @throws IllegalArgumentException if the declaring class of the specified method is not public
     *                                  and either the main proxy is not an instance of that
     *                                  declaring class or the main proxy's class is not public
     */
    ...
    /**
     * Reflectively invoke the method on the main proxy, unless the method's declaring class is not
     * public but the main proxy's class is public, in which case invoke the corresponding method
     * from the main proxy's class instead.
     */
    ...
    /**
     * Returns <code>true</code> if the argument is an instance of this class, and calling the
     * <code>checkTrustEquivalence</code> method on the main proxy of this invocation handler,
     * passing the main proxy of the argument, returns <code>true</code>, and calling the
     * <code>checkTrustEquivalence</code> method on the bootstrap proxy of this invocation handler,
     * passing the bootstrap proxy of the argument, returns <code>true</code>, and returns
    ...
    /**
     * Returns <code>true</code> if the argument is an instance of this class with the same main
     * proxy and the same bootstrap proxy, and <code>false</code> otherwise.
     */
     ...
     *
     * @return an iterator that produces the bootstrap proxy as the only element of the iteration
     */
    ...
    /**
     * Verifies that the main proxy is an instance of {@link TrustEquivalence}, and that the
     * bootstrap proxy is an instance of both {@link RemoteMethodControl} and
     * <code>TrustEquivalence</code>.
     *
     * @throws InvalidObjectException if the main proxy is not an instance of <code>TrustEquivalence</code>,
     *                                or the bootstrap proxy is not an instance of both
