 ...
 * @since 9.0.1
 */
public interface ConsolidatedDistributedTransactionMetaData {
    /**
     * @return The distributed transaction participants count.
     */
    int getTransactionParticipantsCount();

    /**
     * @return The distributed transaction unique id.
     */
