...
/**
 * Provides a means to obtain a client-side proxy from a "base" service object. <p> This interface
 ...
 * non-activatable service is created, {@link NonActivatableServiceDescriptor#create(net.jini.config.Configuration)
 * NonActivatableServiceDescriptor.create()}, returns the result from
 * <code>&lt;impl&gt;.getServiceProxy()</code>, if supported, where <code>&lt;impl&gt;</code> is the
 * service implementation instance. When an activatable service is created, {@link
 * SharedActivatableServiceDescriptor#create(net.jini.config.Configuration)
 * SharedActivatableServiceDescriptor.create()}, returns the result of
 * <code>&lt;act_ref&gt;.getServiceProxy()</code>, if supported, where <code>&lt;act_ref&gt;</code>
 * is the service reference returned by the call to {@link java.rmi.activation.ActivationID#activate(boolean)
...
public interface ServiceProxyAccessor {
    ...
    /**
     * Returns a proxy object for this object. This value should not be <code>null</code>.
     *
