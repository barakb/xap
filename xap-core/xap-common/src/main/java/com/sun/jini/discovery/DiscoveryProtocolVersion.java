 ...
 * Lookup services and discovery clients can use this constraint to control what version(s) of the
 * multicast request, multicast announcement and unicast discovery protocols are used to exchange
...
public final class DiscoveryProtocolVersion
    ...
    /**
     * Returns a <code>DiscoveryProtocolVersion</code> constraint for the given version number.
     *
