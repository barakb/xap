...
public interface ServiceDescriptor {
    /**
     * Creates an object described by the actual <code>ServiceDescriptor</code> instance.
     *
     * @param config The <code>Configuration</code> object used to configure the creation of the
     *               returned object.
     * @return An object instance appropriate for the given service descriptor instance.
