...
public interface UnicastDiscoveryClient extends DiscoveryFormatProvider {
     ...
     * constraints.  <code>null</code> constraints are considered equivalent to empty constraints.
     *
     ...
     * Byte buffers containing the data sent and received so far over the given socket (for the
     * unicast discovery protocol 2 handshake) are provided for use by formats which integrity
     * protect or otherwise incorporate the handshake data.  <code>null</code> constraints are
     ...
     *                                        resolved
     * @throws NullPointerException           if <code>socket</code>, <code>sent</code>, or
     *                                        <code>received</code> is <code>null</code>
     */
