...
public interface MulticastRequestEncoder extends DiscoveryFormatProvider {
     ...
     * <code>null</code> constraints are considered equivalent to empty constraints.  Multicast
     ...
     * and when to split the data based on the available space in the obtained buffers.
     *
     * @param request     the request data to encode
     * @param bufs        the factory for producing buffers in which to write encoded data
     * @param constraints the constraints to apply when encoding the data, or <code>null</code>
     * @throws IOException                                if an error occurs in encoding the data to
     *                                                    send
     * @throws net.jini.io.UnsupportedConstraintException if unable to satisfy the specified
     *                                                    constraints
     * @throws SecurityException                          if the given constraints cannot be
     *                                                    satisfied due to insufficient caller
     *                                                    permissions
     * @throws NullPointerException                       if <code>request</code> or <code>bufs</code>
     *                                                    is <code>null</code>
     *
