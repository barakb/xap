...
public class UnicastResponse {
    ...
    /**
     * Creates new <code>UnicastResponse</code> instance containing the given values.  The
     ...
     * @throws NullPointerException     if <code>host</code> or <code>registrar</code> is
    ...
    public UnicastResponse(String host,
                           int port,
                           String[] groups,
                           ServiceRegistrar registrar, MarshalledObject marshalledObjectRegistrar, byte[] registrarBytes) {
    ...
    public byte[] getRegistrarBytes() {
        return registrarByes;
    }

    public MarshalledObject getMarshalledObjectRegistrar() {
        return marshalledObjectRegistrar;
    }
