...
public class WeakIdentityMap {
    ...
    /**
     * Associates value with given key, returning value previously associated with key, or null if
     * none.
     */
    ...
    /**
     * Removes association for given key, returning value previously associated with key, or null if
     * none.
     */
