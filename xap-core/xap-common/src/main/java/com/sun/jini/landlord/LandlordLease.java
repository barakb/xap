...
/**
 * Basic implementation of <code>net.jini.core.lease.Lease</code> that works with the the Landlord
 * protocol.
 *
...
public class LandlordLease extends AbstractLease implements ReferentUuid {
    ...
    /**
     * The <code>Uuid</code> of the <code>landlord</code>. Used to determine if two leases can be
     * batched together.
     *
     * @serial
     */
     ...
     *
     * @param cookie       a <code>Uuid</code> that universally and uniquely identifies the lease
     *                     this object is to be a proxy for
     * @param landlord     <code>Landlord</code> object that will be used to communicate renew and
     *                     cancel requests to the granter of the lease
    ...
    /**
     * We should always have data in the stream, if this method gets called there is something
     * wrong.
     */
