...
public class MulticastAnnouncement {
    ...
    /**
     * Creates a new <code>MulticastAnnouncement</code> instance containing the given values.  The
     * <code>groups</code> array is copied; a <code>null</code> value is considered equivalent to an
     * empty array.
     *
     ...
     * @throws NullPointerException     if <code>host</code> or <code>serviceID</code> is
     *                                  <code>null</code>, or if <code>groups</code> contains
     *                                  <code>null</code>
     ...
     * are satisfied. If the instance was not decoded, but directly constructed, this method does
     * nothing.
     *
