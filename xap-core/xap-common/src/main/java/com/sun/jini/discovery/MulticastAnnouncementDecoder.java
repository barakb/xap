...
public interface MulticastAnnouncementDecoder extends DiscoveryFormatProvider {
     ...
     * instance that contains the decoded data. <code>null</code> constraints are considered
     * equivalent to empty constraints.  All the specified constraints are checked before this
     * method returns.
     *
     * @param buf         a buffer containing the packet data to decode.  The multicast announcement
     *                    data must begin at position zero of <code>buf</code>.
     * @param constraints the constraints to apply when decoding the data, or <code>null</code>
