...
public final class NewThreadAction implements PrivilegedAction {
    ...
    /**
     * special child of the system thread group for running tasks that may execute user code, so
     * that the security policy for threads in the system thread group will not apply
     */
     ...
     * @param daemon   if true, new thread will be a daemon thread; if false, new thread will not be
     *                 a daemon thread
     */
     ...
     * @param runnable the Runnable for the new thread to execute
     * @param name     the name of the new thread
     * @param daemon   if true, new hread will be a daemon thread; if false, new thread will not be
     *                 a daemon thread
     * @param user     if true, thread will be created in a non-system thread group; if false,
     *                 thread will be created in the system thread group
     */
    public NewThreadAction(Runnable runnable, String name, boolean daemon,
                           boolean user) {
