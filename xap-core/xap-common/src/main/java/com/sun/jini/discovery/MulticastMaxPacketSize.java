...
public final class MulticastMaxPacketSize
    ...
    /**
     * Creates a <code>MulticastMaxPacketSize</code> constraint for the given multicast packet size
     * limit.
     *
     * @param size the multicast packet size limit
     * @throws IllegalArgumentException if the given size is less than {@link #MIN_MAX_PACKET_SIZE}.
     */
