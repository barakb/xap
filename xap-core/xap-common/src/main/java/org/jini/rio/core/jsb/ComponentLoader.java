...
/**
 * The ComponentLoader provides a mechanism for the ServiceBean to load classes and resources (such
 * as native libraries) making them (and the resources it uses) available to all services
 */
public interface ComponentLoader {
    /**
     * Creates an Object which has been added to the ComponentLoader using the addSystemComponent
     * method, or is in the classpath of the ComponentLoader. The Object is loaded from the
     * registered code source.
     *
     * @param name The name of the class. The resulting class will be loaded and a new instance of
     *             the class created using a zero-arg contructor.
     ...
     *                                other reason.
     * @throws ClassNotFoundException - If the class cannot be located by the class loader or it has
     *                                not been registered
     */
     ...
     * @return true If the requested component can be located, false otherwise.
     */
    boolean testComponentExistence(String name);

    /**
     * Test whether a named resource exists. A resource is some data (images, audio, text, etc) that
     * can be accessed by class code in a way that is independent of the location of the code. <p>
