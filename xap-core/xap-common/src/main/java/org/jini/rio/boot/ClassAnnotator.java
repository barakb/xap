...
public class ClassAnnotator implements ClassAnnotation {
    ...
    /**
     * Optional properties the ClassAnnotator may use to control behavior
     */
     ...
     * @param props    Optional properties a ClassAnnotator may use to control behavior
     */
     ...
     * Get the properties
     *
     * @return A Properties object set at creation time. A new Properties object is created each
     * time
     */
