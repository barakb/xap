...
abstract public class TPrimitiveHash extends THash {
    private static final long serialVersionUID = -546639497288125094L;
    ...
    /**
     * Creates a new <code>TPrimitiveHash</code> instance with a prime capacity at or near the
     * minimum needed to hold <tt>initialCapacity<tt> elements with load factor <tt>loadFactor</tt>
    ...
    /**
     * Returns the capacity of the hash table.  This is the true physical capacity, without
     * adjusting for the load factor.
     *
