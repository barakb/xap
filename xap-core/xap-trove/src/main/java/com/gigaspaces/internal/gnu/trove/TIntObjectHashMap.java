...
public class TIntObjectHashMap<V> extends TIntHash implements Externalizable {
    ...
    /**
     * Creates a new <code>TIntObjectHashMap</code> instance with a prime capacity equal to or
    ...
    /**
     * Creates a new <code>TIntObjectHashMap</code> instance whose capacity is the next highest
