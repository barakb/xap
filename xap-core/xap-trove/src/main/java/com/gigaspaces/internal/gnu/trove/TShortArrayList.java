...
public class TShortArrayList implements Externalizable, Cloneable {
    ...
    /**
     * Creates a new <code>TShortArrayList</code> instance whose capacity is the greater of the
    ...
    /**
     * Grow the internal array as needed to accommodate the specified number of elements.  The size
     * of the array shorts on each resize unless <tt>capacity</tt> requires more than twice the
     * current capacity.
     *
     * @param capacity an <code>int</code> value
     */
    ...
    /**
     * Inserts <tt>value</tt> into the list at <tt>offset</tt>.  All values including and to the
     * right of <tt>offset</tt> are shifted to the right.
     *
    ...
    /**
     * Inserts the array of <tt>values</tt> into the list at <tt>offset</tt>.  All values including
     ...
     * the <tt>values</tt> array, starting at valOffset.
     *
     * @param offset    the first offset to replace
     * @param values    the source of the new values
    ...
    /**
     * Sets the size of the list to 0, but does not change its capacity.  This method can be used as
     * an alternative to the {@link #clear clear} method if you want to recyle a list without
     ...
     * Sets the size of the list to 0, but does not change its capacity.  This method can be used as
     * an alternative to the {@link #clear clear} method if you want to recyle a list without
     * allocating new backing arrays.  This method differs from {@link #reset reset} in that it does
     * not clear the old values in the backing array.  Thus, it is possible for {@link #getQuick
     * getQuick} to return stale data if this method is used and the caller is careless about bounds
     * checking.
     *
     * @see #reset
     * @see #clear
    ...
    /**
     * Returns a clone of this list.  Since this is a primitive collection, this will be a deep
     * clone.
     *
    ...
    /**
     * Performs a binary search for <tt>value</tt> in the entire list. Note that you <b>must</b>
     *
     * @param value the value to search for
     * @return the absolute offset in the list of the value, or its negative insertion point into
     * the sorted list.
     * @{link #sort sort} the list before doing a search.
     */
