...
public interface TShortHashingStrategy extends Serializable {
    /**
     * Computes a hash code for the specified short.  Implementors can use the short's own value or
     * a custom scheme designed to minimize collisions for a known set of input.
     *
