...
abstract public class THash implements Cloneable, Externalizable {
     ...
     * a value in the range: 0.0 < loadFactor < 1.0.  The default value is 0.5, which is about as
     ...
     *
     * <ol> <li> You'll free memory allocated to the table but no longer needed because of the
     * remove()s.</li>
     *
     * <li> You'll get better query/insert/iterator performance because there won't be any
     * <tt>REMOVED</tt> slots to skip over when probing for indices in the table.</li> </ol>
     */
    public void compact() {
     ...
     * the previous compaction (or the initial capacity) multiplied by this factor. <p> Setting this
     * value to zero will disable auto-compaction.
     */
    ...
    /**
     * This simply calls {@link #compact compact}.  It is included for symmetry with other
     * collection classes.  Note that the name of this method is somewhat misleading (which is why
     * we prefer <tt>compact</tt>) as the load factor may require capacity above and beyond the size
     * of this collection.
     *
     * @see #compact
     */
