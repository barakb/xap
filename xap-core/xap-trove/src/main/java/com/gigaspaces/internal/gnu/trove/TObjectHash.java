...
abstract public class TObjectHash<T> extends THash
    ...
    /**
     * Creates a new <code>TObjectHash</code> instance with the default capacity and load factor and
    ...
    /**
     * Creates a new <code>TObjectHash</code> instance whose capacity is the next highest prime
     * above <tt>initialCapacity + 1</tt> unless that value is already prime.  Uses the specified
     ...
     * equal()ing <tt>obj</tt> in the set, returns that value's index as <tt>-index - 1</tt>.
     *
     * @param obj an <code>Object</code> value
    ...
    public void readExternal(ObjectInput in)
        ...
        _hashingStrategy = (com.gigaspaces.internal.gnu.trove.TObjectHashingStrategy<T>) in.readObject();
    }
} // TObjectHash
