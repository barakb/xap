...
public class TObjectLongHashMap<K> extends TObjectHash<K> implements Externalizable {
    ...
    /**
     * Creates a new <code>TObjectLongHashMap</code> instance whose capacity is the next highest
    ...
    public TObjectLongHashMap<K> clone() {
        TObjectLongHashMap<K> clone = (com.gigaspaces.internal.gnu.trove.TObjectLongHashMap<K>) super.clone();
