 ...
 *
 * Unlike the {@link EventTemplateProvider} which is called only once, this implementation is called
 ...
 * SpaceDataEventListener} is provided that also controls the template associated with it. Use with
 * {@link org.openspaces.events.polling.SimplePollingEventListenerContainer} or {@link
...
public interface DynamicEventTemplateProvider {
    ...
    /**
     * Returns the template that will be used for matching on events, and is called before each take
     * or read operation.
     */
