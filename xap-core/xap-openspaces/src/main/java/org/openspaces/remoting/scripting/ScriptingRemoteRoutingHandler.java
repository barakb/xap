...
/**
 * A remoting routing handler that uses {@link Script#getRouting()} in order to computer the routing
 * index.
 *
 * @author kimchy
 */
public class ScriptingRemoteRoutingHandler implements RemoteRoutingHandler {
    ...
    /**
     * Only works with {@link org.openspaces.remoting.scripting.ScriptingExecutor} and uses {@link
    ...
    public Object computeRouting(SpaceRemotingInvocation remotingEntry) {
        return ((Script) remotingEntry.getArguments()[0]).getRouting();
    }
}
