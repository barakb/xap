...
/**
 * An extension for {@link java.util.concurrent.ExecutionException} holding both the {@link
 * SpaceRemotingInvocation remoteInvocation} and the {@link SpaceRemotingResult remoteResult} remote
 * result.
 *
 * @author kimchy
 */
