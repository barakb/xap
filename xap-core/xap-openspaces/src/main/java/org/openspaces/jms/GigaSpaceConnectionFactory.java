 ...
 * <code>ConnectionFactory</code> based on a Space instance.
 *
...
public class GigaSpaceConnectionFactory implements FactoryBean, InitializingBean {
     ...
     *
     * <p>Note, the {@link org.openspaces.core.GigaSpace} is used to acquire the {@link
     * com.j_spaces.core.IJSpace} instance allowing to get the "clustered" flag beaviour.
    ...
    public void afterPropertiesSet() throws Exception {
        gsConnectionFactory = new GSConnectionFactoryImpl(gigaSpace.getSpace(), messageConverter);
    }
