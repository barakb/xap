...
/**
 * A callback that sets the merged properties using {@link BeanLevelProperties#getMergedBeanProperties(String)
...
public interface BeanLevelMergedPropertiesAware {
    ...
    /**
     * Sets the merged properties using {@link BeanLevelProperties#getMergedBeanProperties(String)
     * mergedProperties} and the bean name that the bean implementing this interface is associated
     * with.
     */
