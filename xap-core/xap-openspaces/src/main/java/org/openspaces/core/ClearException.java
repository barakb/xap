 ...
 * other spaces is done. Then the aggregated exception is thrown. <br> <p>The exception contains:
 * <ul> <li>An array of exceptions that caused it. One exception per each space that failed. </ul>
 *
