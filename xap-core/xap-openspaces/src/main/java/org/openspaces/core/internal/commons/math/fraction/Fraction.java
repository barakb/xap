...
public class Fraction
    ...
    /**
     * Create a fraction given the double value and maximum error allowed. <p> References: <ul>
     * <li><a href="http://mathworld.wolfram.com/ContinuedFraction.html"> Continued Fraction</a>
     * equations (11) and (22)-(26)</li> </ul> </p>
     *
     * @param value         the double value to convert to a fraction.
    ...
    /**
     * Create a fraction given the double value and maximum denominator. <p> References: <ul> <li><a
     * href="http://mathworld.wolfram.com/ContinuedFraction.html"> Continued Fraction</a> equations
     * (11) and (22)-(26)</li> </ul> </p>
     *
     * @param value          the double value to convert to a fraction.
     ...
     * number of denominator digits. <p>
     *
     * NOTE: This constructor is called with EITHER - a valid epsilon value and the maxDenominator
     ...
     * there is an exact match before the maxDenominator value is reached). </p><p>
     *
     * It has been done this way so that the same code can be (re)used for both scenarios. However
     * this could be confusing to users if it were part of the public API and this constructor
     * should therefore remain PRIVATE. </p>
     *
    ...
    /**
     * Test for the equality of two fractions.  If the lowest term numerator and denominators are
     * the same for both fractions, the two fractions are considered to be equal.
     *
     * @param other fraction to test for equality to this fraction
     * @return true if two fractions are equal, false if object is <tt>null</tt>, not an instance of
    ...
    /**
     * Gets the fraction as a <tt>float</tt>. This calculates the fraction as the numerator divided
     * by denominator.
     *
    ...
    /**
     * <p>Adds the value of this fraction to another, returning the result in reduced form. The
     * algorithm follows Knuth, 4.5.1.</p>
     *
    ...
    /**
     * <p>Multiplies the value of this fraction by another, returning the result in reduced
     * form.</p>
     *
    ...
    /**
     * <p> Returns the <code>String</code> representing this fraction, ie "num / dem" or just "num"
     * if the denominator is one. </p>
     *
