 ...
 * numerator and, denominator can be configured. <p> Minus signs are only allowed in the whole
 * number part - i.e., "-3 1/2" is legitimate and denotes -7/2, but "-3 -1/2" is invalid and will
 * result in a <code>ParseException</code>.</p>
 *
...
public class ProperFractionFormat extends FractionFormat {
     ...
     * @param pos        On input: an alignment field, if desired. On output: the offsets of the
     *                   alignment field
     ...
     * formatted as a proper fraction. <p> Minus signs are only allowed in the whole number part -
     * i.e., "-3 1/2" is legitimate and denotes -7/2, but "-3 -1/2" is invalid and will result in a
