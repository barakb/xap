 ...
 *
 * <p>The exception contains an array of ReadByIdResult objects where each result in the array
...
public class ReadByIdsException extends InvalidDataAccessResourceUsageException {
    ...
    /**
     * Holds a ReadByIdsException result. The result contains the object's Id, the result type, the
