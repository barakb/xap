...
/**
 * Represents a JPQL bound variable expression node. OpenJPA adds this dummy node containing the
 * mapping info when a property is JOINED. The node is translated to a "1 = 1" expression.
 *
 * @author Idan Moyal
 * @since 8.0
 */
