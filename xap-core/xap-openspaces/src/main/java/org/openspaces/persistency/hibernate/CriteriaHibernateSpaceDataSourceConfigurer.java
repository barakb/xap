...
public class CriteriaHibernateSpaceDataSourceConfigurer {
     ...
     */
    public CriteriaHibernateSpaceDataSourceConfigurer initialLoadQueryScanningBasePackages(String[] initialLoadQueryScanningBasePackages) {
        this.initialLoadQueryScanningBasePackages = initialLoadQueryScanningBasePackages;
        return this;
    }

    /**
     * Injects the {@link org.openspaces.core.cluster.ClusterInfo} to be used with the
     * SpaceDataSource
     */
     ...
     */
    public CriteriaHibernateSpaceDataSourceConfigurer augmentInitialLoadEntries(boolean augmentInitialLoadEntries) {
