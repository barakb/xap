...
/**
 * A default batch iterator that is based on {@link StatelessListQueryDataIterator} for each chunk.
 *
 * @author kimchy
 */
public class StatelessChunkListDataIterator extends AbstractChunkDataIterator {
     ...
     */
    public StatelessChunkListDataIterator(String entityName, SessionFactory sessionFactory, int fetchSize, boolean performOrderById, int chunkSize) {
     ...
     * @param chunkSize        The size of the chunks the entity table will be broken to
     */
    public StatelessChunkListDataIterator(SQLQuery sqlQuery, SessionFactory sessionFactory, int fetchSize, boolean performOrderById, int chunkSize) {
     ...
     * @param chunkSize      The size of the chunks the entity table will be broken to
     */
    public StatelessChunkListDataIterator(String hQuery, SessionFactory sessionFactory, int fetchSize, int chunkSize) {
