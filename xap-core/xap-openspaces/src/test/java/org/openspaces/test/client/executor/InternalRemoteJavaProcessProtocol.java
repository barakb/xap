...
/**
 * Internal remote interface provides communication protocol between RemoteJavaCommand and
 * RemoteJavaProcess.<br> {@link #invoke(String, Class[], Object[])} allows to {@link
 * RemoteJavaCommand} to invoke remote method of user-defined {@link RemoteJavaCommand} remote
 * interface. <br> No needs to compile rmic stubs all remote method invocation performs via {@link
