...
public class JMSOfflineStateDurSubDataEntry extends MetaDataEntry implements IReplicatable {
    private static final long serialVersionUID = -4291015238413460411L;
     ...
     * unique name. if false, then this durableTopic was unsubscribed and no longer act as a durable
    ...
    /**
     * if true then this durable topic is currently subscribed with the m_durableSubscriptionName
     * unique name, and the topic subscriber is currently online. if false, then this durable Topic
     * subscriber is currently offline and it indicates to the JMSDurableSubService to collect all
     ...
     * topic name (e.g. SpaceName_TopicName). We later create single specific durable consumer
     * subscription to a topic, according to this consumer client id.
     */
     ...
     *
     */
    public JMSOfflineStateDurSubDataEntry() {
        setFifo(true);
    }
...
//	}
    ...
    public String toString() {
        return "	JMSOfflineStateDurSubDataEntry " +
