...
public class ClassLoading {
    ...
    /**
     * Load a class for the given name. <p/> <p> Handles loading primitive types as well as VM class
     * and array syntax.
     *
     ...
     */
    private static final HashMap<String, Class> VM_PRIMITIVES = new HashMap<String, Class>();
     ...
     */
    private static final HashMap<Class, String> VM_PRIMITIVES_REVERSE = new HashMap<Class, String>();
    ...
    /**
     * Get the primitive type for the given VM primitive name. <p/> <p> Mapping:
     *
     * <pre>
     *
     *    B - byte
