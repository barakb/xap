...
/**
 * GigaSpaces implementation of the <code>javax.jms.TemporaryQueue</code> interface. This class
...
public class GSTemporaryQueueImpl extends GSQueueImpl implements TemporaryQueue, Serializable {
     ...
     * @param srcID
     */
    public GSTemporaryQueueImpl(String queueName, String srcID/*, GSSessionImpl session*/) {
        super(TEMP_QUEUE_PREFIX + queueName);
     ...
     *
     * @see TemporaryQueue#delete()
     */
    public void delete() throws JMSException {
//		try
//			{
//				session.conn.getSpace().clear( session.prepareJMSTemplateEntry(getQueueName()), null);
//			}
...
//			{
//				   JMSException e = 
//						new JMSException("TransactionException in GSTemporaryQueueImpl.delete() "+te.getMessage());
...
//			{
//					JMSException e = 
//							new JMSException("RemoteException in GSTemporaryQueueImpl.delete "+re.getMessage());
...
//			{
//				JMSException e = 
//							new JMSException("UnusableEntryException in GSTemporaryQueueImpl.delete "+ue.getMessage());
...
//			}
    ...
    public String getDescription() {
        return "GSTemporaryQueueImpl  | Destination name:  " +
                toString() +
                "  |  sourceID: " + sourceID;
    }
