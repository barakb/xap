...
/**
 * Base interface that expose mule meta data. and explicitly expose UniqueId attribute. <p>
 * <B>Note:</B> implementation of this interface must have consistent results with equivalent
